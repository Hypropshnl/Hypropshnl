...
class BillPaymentController extends Controller
{
    ...
    public function getCreditBalance($dataObj){
        ...
        foreach($dataObj as $data){
            ...
            $creditBal = JournalExtension::sumColumnDataCondition3('vendor_customer',$data->vendor_customer,'transaction_type',finance::vendorCredit, 'journal_status', Utility::STATUS_ACTIVE,'balance_trans');
            $debitMemoList = JournalExtension::specialColumns3('vendor_customer',$data->vendor_customer,'transaction_type',finance::vendorCredit, 'journal_status', Utility::STATUS_ACTIVE);
            $data->vendorDebitMemoList = $debitMemoList;
