...
class InventoryRecordController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function publicItemSearch(Request $request)
    {
        //
        return view::make('inventory_record.public_item_search');

    }

    public function processPublicItemSearch(Request $request)
    {
        //
        ...
        $searchData = InventoryRecord::firstRow('item_id', $itemId);

        if($searchData->count() > 0){
            return view::make('inventory_record.public_item_display')->with('mainData',$searchData);
        }else{
