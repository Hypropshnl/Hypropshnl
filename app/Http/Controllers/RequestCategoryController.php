...
class RequestCategoryController extends Controller
{
    ...
    {
        $mainData = (in_array(Auth::user()->role,Utility::TOP_USERS)) ? RequestCategory::paginateAllData() :
            RequestCategory::specialColumnsOr2Page('dept_id',Auth::user()->dept_id, 'general', Utility::STATUS_ACTIVE);
   ...
   public function changeStatus(Request $request)
    {
        ...
        RequestCategory::massUpdate('id',$idArray,$dbData);
