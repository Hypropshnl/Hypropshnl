...
class TaskController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        if($validator->passes()) {
            ...
            $formUserColumn = ($taskTbl->user_type == Utility::P_USER) ? 'assigned_user' : 'temp_user';
            $formUserColumn = ($taskTbl->user_type == '') ? '': $formUserColumn;

            $formUserDbTbl = ($taskTbl->user_type == Utility::P_USER) ? 'users' : 'temp_users';
            $formUserDbTbl = ($taskTbl->user_type == '') ? '': $formUserDbTbl;
