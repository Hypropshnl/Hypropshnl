...
class SalesMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $message = $this->view('mail_views.sales_order');
        ...
        $message->with([ 'message' => $this->data,'itemComponents' => $this->data['salesData'],
         'itemDetail' => $this->data['sales'], 'currencyCode' => $this->data['currency'] ]);
        return $message;
    }
}
