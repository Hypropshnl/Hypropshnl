...
class AccountJournal extends Model
{
    ...
    {
		return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column, '=',$post)
		->where($column2, '=',$post2)->sum('sum_total');
    ...
    {
		return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column, '=',$post)
		->where($column2, '=',$post2)->where($column3, '=',$post3)->sum('sum_total');
    ...
    public static function specialColumnsDate33($column, $post, $column2, $post2, $column3, $post3,$dateArray)
    {
        return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column,$post)
            ->where($column2, $post2)->where($column3, $post3)
            ->whereBetween('post_date',$dateArray)
    ...
    public static function specialColumnsDate44($column, $post, $column2, $post2, $column3, $post3,$dateArray)
    {
        return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column,$post)
            ->where($column2, $post2)->where($column3, '=',$post3)
            ->whereBetween('post_date',$dateArray)
    ...
    public static function specialColumnsOrDate44($column, $post, $column2, $post2, $column3, $post3,$column4, $post4,$dateArray)
    {
        return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column,$post)
            ->where($column2, $post2)
            ->where(function ($query) use($column3, $post3, $column4, $post4){
                $query->where($column3, '=',$post3)->orWhere($column4, '=',$post4);
           })
            ->whereBetween('post_date',$dateArray)
            ->orderBy('id','DESC')->get();
    ...
    public static function specialColumnsDateTransaction($column, $post,$dateArray)
    {
        ...
        return static::where('status', '=',Utility::STATUS_ACTIVE)->whereIn($column,$post)
            ...
            ->get(['extension_id','acct_cat_id','id','sum_total','trans_total','transaction_type','cash_status','post_date','status','debit_credit','chart_id','item_id','vendor_customer','class_id','location_id','employee_id','created_by','updated_by','created_at','updated_at']);
    ...
    public static function specialArrayColumnsDateTransaction4($column, $post, $column2, $post2, $column3, $post3, $column4, $post4,$dateArray)
    {
        ...
        return static::where('status', '=',Utility::STATUS_ACTIVE)->whereIn($column,$post)
            ->where($column2, $post2)->where($column3, $post3)->where($column4, $post4)
            ->whereBetween('post_date',$dateArray)
            ->orderBy('id','DESC')->get(['extension_id','acct_cat_id','id','sum_total','trans_total','transaction_type','cash_status','post_date','status','debit_credit','chart_id','item_id','vendor_customer','class_id','location_id','employee_id','created_by','updated_by','created_at','updated_at']);
