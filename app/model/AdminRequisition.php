...
class AdminRequisition extends Model
{
    ...
    public function approval(){
        return $this->belongsTo('App\model\AdminApprovalSys','approval_id','id')->withDefault();
    ...
    public function requestCat(){
        return $this->belongsTo('App\model\AdminCategory','req_cat','id')->withDefault();
    ...
    public static function specialColumnsPageOr2($column, $post, $column2, $post2)
    {
        ...
        //->where($column, '=',$post)->orWhere($column2, '=',$post2)->orderBy('id','DESC')->paginate(Utility::P35);
