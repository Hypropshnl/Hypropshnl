...
class AppraisalReviewerComments extends Model
{
    //
    protected  $table = 'appraisal_reviewer_comments';

    private static function table(){
        return 'appraisal_reviewer_comments';
    }
    /**
    ...
    public function recommend(){
        return $this->belongsTo('App\model\AppraisalRecommendation','recommendation_id','id')->withDefault();

    }
    public function rating(){
        return $this->belongsTo('App\model\AppraisalRatings','rating_id','id')->withDefault();
