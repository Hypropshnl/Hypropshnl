...
class AttendanceTimeSchedule extends Model
{
    //
    protected  $table = 'attendance_time_schedule';

    private static function table(){
        return 'attendance_time_schedule';
    }
    /**
    ...
    public static $mainRules = [
        ...
        'work_days' => 'required',
        'late_start_time' => 'required',
        'absence_start_time' => 'required',
        'late_request_start_time' => 'required',
        'late_request_end_time' => 'required',
        'geo_tag' => 'required',
        'time_zone' => 'required',
    ];
    ...
    public function geoTag(){
        return $this->belongsTo('App\model\AttendanceGeoTag','geo_tag_id','id')->withDefault();

    }

    public function timeZone(){
        return $this->belongsTo('App\model\AttendanceTimeZone','time_zone_id','id')->withDefault();
