...
class CompetencyFramework extends Model
{
    ...
    public static $copyRules = [
        'copy_from_department' => 'required',
        'copy_from_position' => 'required',
        'copy_to_department' => 'required',
        'copy_to_position.*' => 'required',
        'copy_to_competency' => 'required'
    ];
