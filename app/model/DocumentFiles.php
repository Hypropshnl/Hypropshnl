...
class DocumentFiles extends Model
{
    ...
    public function document(){
        return $this->belongsTo('App\model\Documents','document_id','id')->withDefault();
    ...
    {
        return static::where('status', '=',Utility::STATUS_ACTIVE)->whereNull('parent_id')->orderBy('id','DESC')->paginate('15');
        //return Utility::paginateAllData(self::table());
