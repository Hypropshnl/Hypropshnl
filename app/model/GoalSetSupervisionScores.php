...
class GoalSetSupervisionScores extends Model
{
    //
    protected  $table = 'goal_set_supervision_scores';

    private static function table(){
        return 'goal_set_supervision_scores';
    }
    /**
    ...
    public function goal_set(){
        return $this->belongsTo('App\model\UnitGoalSeries','goal_set_id','id')->withDefault();
