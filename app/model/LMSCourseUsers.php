...
class LMSCourseUsers extends Model
{
    //
    protected  $table = 'lms_course_users';

    private static function table(){
        return 'lms_course_users';
    }
    /**
    ...
    {
        return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column, '=',$post)->orderBy('updated_at','DESC')->paginate(Utility::P50);
