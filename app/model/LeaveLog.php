...
class LeaveLog extends Model
{
    ...
    public function approval(){
        return $this->belongsTo('App\model\HrisApprovalSys','approval_id','id')->withDefault();

    }

    public function leaveType(){
        return $this->belongsTo('App\model\LeaveType','leave_type','id')->withDefault();
    ...
    public static function specialColumnsDate2($column, $post, $column2, $post2,$column3,$date)
    {
        //return Utility::specialColumns2(self::table(),$column, $post, $column2, $post2);
		return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column, '=',$post)
		->where($column2, '=',$post2)->where($column3, '>=',$date)->orderBy('id','DESC')->get();
