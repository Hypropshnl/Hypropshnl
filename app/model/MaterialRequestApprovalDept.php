...
class MaterialRequestApprovalDept extends Model
{
    //
    protected  $table = 'material_request_approval_dept';

    private static function table(){
        return 'material_request_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\materialRequestApprovalSys','approval_id','id');
