...
class PoExtension extends Model
{
    ...
    public function po(){
        return $this->hasMany('App\model\PurchaseOrder','po_id','id')->where('status','=',Utility::STATUS_ACTIVE)->orderBy('id', 'asc');
    ...
    public function mrData(){
        return $this->belongsTo('App\model\MaterialRequestExtension','mr_id','id')->withDefault();
