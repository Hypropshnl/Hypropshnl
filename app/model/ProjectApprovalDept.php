...
class ProjectApprovalDept extends Model
{
    //
    protected  $table = 'project_approval_dept';

    private static function table(){
        return 'project_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\ProjectApprovalSys','approval_id','id');
