...
class ProjectLeaveApprovalDept extends Model
{
    //
    protected  $table = 'project_leave_approval_dept';

    private static function table(){
        return 'project_leave_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\ProjectLeaveApprovalSys','approval_id','id');
