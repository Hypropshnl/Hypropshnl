...
class ProjectMaterialRequestApprovalDept extends Model
{
    //
    protected  $table = 'project_material_request_approval_dept';

    private static function table(){
        return 'project_material_request_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\ProjectMaterialRequestApprovalSys','approval_id','id');
