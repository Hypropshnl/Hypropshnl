...
class ProjectMaterialRequestApprovalSys extends Model
{
    //
    protected  $table = 'project_material_request_approval_sys';

    private static function table(){
        return 'project_material_request_approval_sys';
    }
    /**
