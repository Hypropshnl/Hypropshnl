...
class ProjectPoApprovalDept extends Model
{
    //
    protected  $table = 'project_po_approval_dept';

    private static function table(){
        return 'project_po_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\ProjectPoApprovalSys','approval_id','id')->withDefault();
