...
class ProjectVehicleServiceLogApprovalDept extends Model
{
    //
    protected  $table = 'project_vehicle_service_log_approval_dept';

    private static function table(){
        return 'project_vehicle_service_log_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\ProjectVehicleRepairApprovalSys','approval_id','id');
