...
class ProjectVehicleServiceLogApprovalSys extends Model
{
    //
    protected  $table = 'project_vehicle_service_log_approval_sys';

    private static function table(){
        return 'project_vehicle_service_log_approval_sys';
    }
    /**
