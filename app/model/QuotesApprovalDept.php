...
class QuotesApprovalDept extends Model
{
    //
    protected  $table = 'quotes_approval_dept';

    private static function table(){
        return 'quotes_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\QuotesApprovalSys','approval_id','id');
