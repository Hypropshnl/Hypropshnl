...
class RFQApprovalDept extends Model
{
    //
    protected  $table = 'rfq_approval_dept';

    private static function table(){
        return 'rfq_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\RFQApprovalSys','approval_id','id');
