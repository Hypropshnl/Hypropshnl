...
class RFQBidApprovalDept extends Model
{
    //
    protected  $table = 'rfq_bid_approval_dept';

    private static function table(){
        return 'rfq_bid_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\RFQBidApprovalSys','approval_id','id')->withDefault();
