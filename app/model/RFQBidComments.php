...
class RFQBidComments extends Model
{
    //
    protected  $table = 'rfq_bid_comments';

    private static function table(){
        return 'rfq_bid_comments';
    }
    /**
    ...
    public function rfqDetail(){
        return $this->belongsTo('App\model\RFQ','rfq_id','id')->withDefault();

    }

    public function rfqBidData(){
