...
class RFQBidItems extends Model
{
    //
    protected  $table = 'rfq_bid_items';

    private static function table(){
        return 'rfq_bid_items';
    }
    /**
    ...
    public function rfqDetail(){
        return $this->belongsTo('App\model\RFQ','rfq_id','rfq_id')->withDefault();

    }

    public function bidDetail(){
        return $this->belongsTo('App\model\RFQBid','rfq_bid_id','id')->withDefault();
    ...
    public static function suggestData($column, $post)
    {
        return static::where('status', '=',Utility::STATUS_ACTIVE)->whereIn($column,$post)->orderBy('item_id','DESC')->get();
