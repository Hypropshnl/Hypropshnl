...
class RequestCategory extends Model
{
    ...
    {
        return static::where('status', '=','1')->orderBy('request_name','ASC')->get();
    ...
    public static function specialColumnsOr2Page($column, $post, $column2, $post2)
    {
        return static::where('status', Utility::STATUS_ACTIVE)
        ->where('active_status', Utility::STATUS_ACTIVE)
        ->where(function ($query) use ($column, $post, $column2, $post2) {
