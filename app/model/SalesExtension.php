...
class SalesExtension extends Model
{
    ...
    public function dataStatus(){
        return $this->belongsTo('App\model\AccountStatus','sales_status','id');
