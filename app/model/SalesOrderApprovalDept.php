...
class SalesOrderApprovalDept extends Model
{
    //
    protected  $table = 'sales_order_approval_dept';

    private static function table(){
        return 'sales_order_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\SalesOrderApprovalSys','approval_id','id');
