...
class Stock extends Model
{
    ...
    public function poItem(){
        return $this->belongsTo('App\model\PoExtension','po_id','id')->withDefault();
    }

    public function salesItem(){
        return $this->belongsTo('App\model\SalesExtension','sales_id','id')->withDefault();
    }
    ...
    public static function specialColumnsNotPage($column, $post)
    {
    ...
    public static function specialColumnsNot3($column, $post, $column2, $post2, $column3, $post3)
    {
        return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column, '=',$post)
            ->where($column2, '=',$post2)->where($column3, '!=',$post3)->orderBy('id','DESC')->get();
