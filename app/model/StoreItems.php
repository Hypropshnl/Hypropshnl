...
class StoreItems extends Model
{
     ...
     * @var array
     */
    public static $mainRules = ['quantity' => 'required'];

    public static $receiptRules = ['place_quantity.*' => 'required',
                                    'department.*' => 'required',
                                    ];

    public static $shipmentRules = ['place_quantity.*' => 'required',
                                    'department.*' => 'required',
                                    ];
    ...
    public function store(){
        return $this->belongsTo('App\model\StoreLocations','store_id','id')->withDefault();
    }
    ...
    public static function defaultUpdate($column, $postId, $arrayDataUpdate=[])
    {
     ...
     public static function defaultUpdate3($column, $post,$column2, $post2,$column3, $post3, $arrayDataUpdate=[])
    {

        return static::where($column , $post)->where($column2, '=',$post2)->where($column3, '=',$post3)->update($arrayDataUpdate);
