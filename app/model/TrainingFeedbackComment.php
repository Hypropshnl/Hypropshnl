...
class TrainingFeedbackComment extends Model
{
    //
    protected  $table = 'training_feedback_comment';

    private static function table(){
        return 'trainin_feedback_comment';
    }
    /**
    ...
    public static $mainRules = [
        'rate_0' => 'required',
        'training_rates_name_0' => 'required',
    ];
    ...
    public function train(){
        return $this->belongsTo('App\model\training','training_id','training_id')->withDefault();
