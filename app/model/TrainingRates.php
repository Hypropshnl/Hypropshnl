...
class TrainingRates extends Model
{
    //
    protected  $table = 'training_rates';

    private static function table(){
        return 'training_rates';
    }
    /**
    ...
    public static $mainRules = [
        'training_rates_name' => 'required',
        'start_rate_0' => 'required',
        'mid_rate_0' => 'required',
    ];
    ...
    public function training_items(){
        return $this->hasMany('App\model\TrainingRatesItems','training_id','id');
    ...
    {
        return static::where('status', '=',Utility::STATUS_ACTIVE)->orderBy('id','ASC')->get();
