...
class TrainingRatesItems extends Model
{
    //
    protected  $table = 'training_rates_item';

    private static function table(){
        return 'training_rates_item';
    }
    /**
    ...
    public function make(){
        return $this->belongsTo('App\model\training_rates','training_id','id')->withDefault();
