...
class UnitGoalReviewerScores extends Model
{
    //
    protected  $table = 'unit_goal_reviewer_scores';

    private static function table(){
        return 'unit_goal_reviewer_scores';
    }
    /**
    ...
    public static function specialColumnsAvg4($column, $post, $column2, $post2, $column3, $post3, $column4, $post4, $avgColumn = 'perct_score')
    {
    ...
    public static function specialColumnsSum4($column, $post, $column2, $post2, $column3, $post3, $column4, $post4, $sumColumn = 'final_score')
    {
		return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column, '=',$post)
		->where($column2, '=',$post2)->where($column3, '=',$post3)->where($column4, '=',$post4)->sum($sumColumn);
