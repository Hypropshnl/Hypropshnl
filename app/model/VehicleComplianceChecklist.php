...
class VehicleComplianceChecklist extends Model
{
    //
    protected  $table = 'vehicle_compliance_checklist';

    private static function table(){
        return 'vehicle_compliance_checklist';
    }
    /**
    ...
    public static $mainRules = [
        'name' => 'required',
        'last_audit_date' => 'required',
        'next_audit_date' => 'required',
        'prompt_emails' => 'required'
    ];
