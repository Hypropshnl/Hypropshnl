...
class VehicleRepairApprovalDept extends Model
{
    //
    protected  $table = 'vehicle_repair_approval_dept';

    private static function table(){
        return 'vehicle_repair_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\VehicleRepairApprovalSys','approval_id','id')->withDefault();
