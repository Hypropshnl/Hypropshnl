...
class VehicleServiceLogApprovalDept extends Model
{
    //
    protected  $table = 'vehicle_service_log_approval_dept';

    private static function table(){
        return 'vehicle_service_log_approval_dept';
    }
    /**
    ...
    public function approval(){
        return $this->belongsTo('App\model\VehicleServiceLogApprovalSys','approval_id','id')->withDefault();
