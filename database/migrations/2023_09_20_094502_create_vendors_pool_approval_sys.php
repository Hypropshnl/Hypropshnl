...
class CreateVendorsPoolApprovalSys extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vendors_pool_approval_sys', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('vendors_pool_approval_sys');
    }
}
