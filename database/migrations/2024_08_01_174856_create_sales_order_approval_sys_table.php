...
class CreateSalesOrderApprovalSysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_order_approval_sys', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sales_order_approval_sys');
    }
}
