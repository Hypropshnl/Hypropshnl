...
class CreateProjectApprovalSysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_approval_sys', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('project_approval_sys');
    }
}
