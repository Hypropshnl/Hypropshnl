...
class CreateRfqBidApprovalSysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rfq_bid_approval_sys', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('rfq_bid_approval_sys');
    }
}
