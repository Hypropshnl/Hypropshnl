                    ...
                    <form name="import_excel" id="searchMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="body">
                            ...
                            <div class="row clear-fix">
                                ...
                                @if(in_array(Auth::user()->role,\App\Helpers\Utility::TOP_USERS) || $appAccess == \App\Helpers\Utility::STATUS_ACTIVE)
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-line">
                            ...
                            <div class="row clear-fix">
                                ...
                                @elseif($detectHod == \App\Helpers\Utility::HOD_DETECTOR && !in_array(Auth::user()->role,\App\Helpers\Utility::TOP_USERS))
