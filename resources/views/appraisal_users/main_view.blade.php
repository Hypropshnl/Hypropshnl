        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <form name="import_excel" id="createMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="body">
                            <div class="row clearfix">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-line">
                                            <select  class="form-control" name="goal_set" >
                                                <option value="" selected>Select Goal Set/Cycle</option>
                                                @foreach($goalSet as $de)
                                                <option value="{{$de->id}}">{{$de->goal_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <b>Reviewer (optional)</b>
                                        <div class="form-line">
                                            <input type="text" class="form-control" autocomplete="off" id="select_user011" onkeyup="searchOptionList('select_user011','myUL011','{{url('default_select')}}','default_search','user011');" name="select_user" placeholder="Select Reviewer">

                                            <input type="hidden" class="user_class" name="reviewer" id="user011" />
                                        </div>
                                    </div>
                                    <ul id="myUL011" class="myUL"></ul>
                                </div>
                ...
                <div class="modal-footer">
                    <button type="button" onclick="submitDefaultWithItems('createModal','createMainForm','<?php echo url('create_assign_goal_set'); ?>','reload_data',
                            '<?php echo url('assign_goal_set'); ?>','<?php echo csrf_token(); ?>','kid_checkbox')" class="btn btn-info">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <b>Reviewer (optional)</b>
                                        <div class="form-line">
                                            <input type="text" class="form-control" autocomplete="off" id="select_user0111" onkeyup="searchOptionList('select_user0111','myUL0111','{{url('default_select')}}','default_search','user0111');" name="select_user" placeholder="Select Reviewer">

                                            <input type="hidden" class="user_class" name="reviewer" id="user0111" />
                                        </div>
                                    </div>
                                    <ul id="myUL0111" class="myUL"></ul>
                                </div>
                ...
                <div class="modal-footer">
                    <button type="button" onclick="submitDefaultWithItems('editModal','editMainForm','<?php echo url('create_assign_goal_set'); ?>','reload_data',
                            '<?php echo url('assign_goal_set'); ?>','<?php echo csrf_token(); ?>','kid_checkbox_assigned')" class="btn btn-info">
                        <i class="fa fa-check-square-o"></i>Assign
                    </button>
                    <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                </div>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Assign Goal Set/Cycle To User(s)
                    </h2>
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox_assigned','reload_data','<?php echo url('assign_goal_set'); ?>',
                                    '<?php echo url('delete_assign_goal_set'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <form name="import_excel" id="searchMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <button class="btn btn-info" type="button" onclick="searchReport('searchMainForm','<?php echo url('search_assign_goal_set'); ?>','reload_data_search',
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <form name="searchAssignForm" id="searchAssignForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <button class="btn btn-info" type="button" onclick="searchReport('searchAssignForm','<?php echo url('search_user_assign_goal_set'); ?>','reload_data',
                                                '','<?php echo csrf_token(); ?>')">Search Users</button>
                                    </div>
                                </div>
                            </form>
                                ...
                                <table class="table table-bordered table-hover table-striped" id="main_table">
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">
                                            ...
                                            <input value="{{$data->id}}" type="checkbox" id="{{$data->user_id}}_assigned" class="kid_checkbox_assigned" />
                                        ...
                                        <td>{{$data->goalSet->goal_name}}</td>
                                        <td>
                                            {{$data->department->dept_name}}
                                        </td>
                                        <td>{{$data->reviewer->firstname}} {{$data->reviewer->lastname}}</td>
