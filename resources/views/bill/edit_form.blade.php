        ...
        @foreach($attach as $at)
            ...
            <tr id="removeAttach{{$num}}">
                ...
                <td>
                    ...
                    <button type="button"  onclick="removeMediaForm('removeAttach{{$num}}','removeAttachForm','<?php echo url('bill_remove_attachment'); ?>','reload_data',
                            '<?php echo url('bill'); ?>','<?php echo csrf_token(); ?>')"
