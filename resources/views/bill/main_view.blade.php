        ...
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Bill</h4>
                    ...
                    <form name="import_excel" id="createMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        Grand Total(Vendor Curr(Incl. Tax)) {{\App\Helpers\Utility::defaultCurrency()}}
                                        <div class="form-line">
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaFormClass('createModal','createMainForm','<?php echo url('create_bill'); ?>','reload_data',
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('editModal','editMainForm','<?php echo url('edit_bill'); ?>','reload_data',
                            '<?php echo url('bill'); ?>','<?php echo csrf_token(); ?>',[
     ...
     <div class="modal fade" id="convertPoModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Convert to bill</h4>
                    <li class="dropdown pull-right">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('convertPoModal','convertPoForm','<?php echo url('create_bill'); ?>','reload_data',
                            '<?php echo url('bill'); ?>','<?php echo csrf_token(); ?>',[
    ...
    <div class="modal fade" id="convertSalesModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('convertSalesModal','convertSalesForm','<?php echo url('create_bill'); ?>','reload_data',
                            '<?php echo url('bill'); ?>','<?php echo csrf_token(); ?>',[
                                'inv_class_edit','item_desc_edit','quantity_edit','unit_cost_edit','unit_measure_edit','tax_edit',
                            'tax_perct_edit','tax_amount_edit','discount_perct_edit','discount_amount_edit','sub_total_edit',
                            'acc_class_edit','acc_desc_edit','acc_rate_edit','acc_tax_edit','acc_tax_perct_edit',
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('bill'); ?>',
                                    '<?php echo url('delete_bill'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                                <i class="fa fa-trash-o"></i>Delete
                            </button>
                        </li>
                        <li>
                            <button type="button" onclick="statusChangeWithReason('kid_checkbox','reload_data','<?php echo url('bill'); ?>',
                ...
                <div class="body">
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <button style="cursor: pointer;" class="btn btn-info" onclick="convertForm('convertPo','convert_po_content','<?php echo url('convert_po_bill_form') ?>','<?php echo csrf_token(); ?>','convertPoModal','convert_sales_content')"><i class="fa fa-pencil-square-o "></i>Convert PO to Bill</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <button style="cursor: pointer;" class="btn btn-info" onclick="convertForm('convertSales','convert_sales_content','<?php echo url('convert_sales_bill_form') ?>','<?php echo csrf_token(); ?>','convertSalesModal','convert_po_content')"><i class="fa fa-pencil-square-o "></i>Convert Sales to Bill</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 ">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="search_bill" class="form-control"
                                       onkeyup="searchItem('search_bill','reload_data','<?php echo url('search_bill') ?>','{{url('bill')}}','<?php echo csrf_token(); ?>')"
                                       name="search_bill" placeholder="Search bill" >
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function getData(page){
        var searchVal = $('#search_bill').val();
        var pageData = '';
        if(searchVal == ''){
            pageData = '?page=' + page;
        }else{
            pageData = '<?php echo url('search_bill') ?>?page=' + page+'&searchVar='+searchVal;
        }
