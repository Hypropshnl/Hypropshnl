        ...
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaForm('editModal','editMainForm','<?php echo url('create_bill_payment'); ?>','reload_data',
                        '<?php echo url('bill_payment'); ?>','<?php echo csrf_token(); ?>')" class="btn btn-info waves-effect">
                    SAVE CHANGES
                    </button>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="fetchMultipleData('kid_checkbox','edit_content','editModal','<?php echo url('edit_bill_payment_form') ?>','<?php echo csrf_token(); ?>');" class="btn btn-success">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="search_bill_payment" class="form-control"
                                       onkeyup="searchItem('search_bill_payment','reload_data','<?php echo url('search_bill_payment') ?>','{{url('bill_payment')}}','<?php echo csrf_token(); ?>')"
                                       name="search_bill_payment" placeholder="Search Open Bill" >
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function getData(page){
        ...
        if(searchVal == ''){
            ...
            pageData = '<?php echo url('search_bill_payment') ?>?page=' + page+'&searchVar='+searchVal;
        }
