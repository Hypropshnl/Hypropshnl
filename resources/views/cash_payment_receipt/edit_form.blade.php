    ...
    <div class="body">
        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="form-control" autocomplete="off" id="select_acc_cash_edit" onkeyup="searchOptionList('select_acc_cash_edit','myUL_cash_acc_edit','{{url('default_select')}}','search_accounts','acc_cash_edit');" name="select_account" placeholder="Select Account">

                        <input type="hidden" value="" class=""  name="receipt_account" id="acc_cash_edit" />
                    </div>
                </div>
                <ul id="myUL_cash_acc_edit" class="myUL"></ul>
            </div>
            <div class="col-sm-4">
                Payment Method
                <div class="form-group">
        ...
        @foreach($attach as $at)
            ...
            <tr id="removeAttach{{$num}}">
                ...
                <td>
                    ...
                    <button type="button"  onclick="removeMediaForm('removeAttach{{$num}}','removeAttachForm','<?php echo url('cash_receipt_remove_attachment'); ?>','reload_data',
                            '<?php echo url('cash_receipt'); ?>','<?php echo csrf_token(); ?>')"
