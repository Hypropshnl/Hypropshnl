        ...
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Cash Receipt</h4>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="hidden" value="" class=""  name="receipt_account" id="acc_cash" />
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaFormClass('createModal','createMainForm','<?php echo url('create_cash_receipt'); ?>','reload_data',
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('editModal','editMainForm','<?php echo url('edit_cash_receipt'); ?>','reload_data',
                            '<?php echo url('cash_receipt'); ?>','<?php echo csrf_token(); ?>',[
     ...
     <div class="modal fade" id="convertPoModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Convert to Cash Receipt</h4>
                    <li class="dropdown pull-right">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('convertPoModal','convertPoForm','<?php echo url('create_cash_receipt'); ?>','reload_data',
                            '<?php echo url('cash_receipt'); ?>','<?php echo csrf_token(); ?>',[
    ...
    <div class="modal fade" id="convertSalesModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('convertSalesModal','convertSalesForm','<?php echo url('create_cash_receipt'); ?>','reload_data',
                            '<?php echo url('cash_receipt'); ?>','<?php echo csrf_token(); ?>',[
                                'inv_class_edit','item_desc_edit','quantity_edit','unit_cost_edit','unit_measure_edit','tax_edit',
                            'tax_perct_edit','tax_amount_edit','discount_perct_edit','discount_amount_edit','sub_total_edit',
                            'acc_class_edit','acc_desc_edit','acc_rate_edit','acc_tax_edit','acc_tax_perct_edit',
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('cash_receipt'); ?>',
                                    '<?php echo url('delete_cash_receipt'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                ...
                <div class="body">
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <button style="cursor: pointer;" class="btn btn-info" onclick="convertForm('convertPo','convert_po_content','<?php echo url('convert_po_cash_receipt_form') ?>','<?php echo csrf_token(); ?>','convertPoModal','convert_sales_content')"><i class="fa fa-pencil-square-o "></i>Convert PO to Cash Receipt</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <button style="cursor: pointer;" class="btn btn-info" onclick="convertForm('convertSales','convert_sales_content','<?php echo url('convert_sales_cash_receipt_form') ?>','<?php echo csrf_token(); ?>','convertSalesModal','convert_po_content')"><i class="fa fa-pencil-square-o "></i>Convert Sales to CashReceipt</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 ">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="search_cash_receipt" class="form-control"
                                       onkeyup="searchItem('search_cash_receipt','reload_data','<?php echo url('search_cash_receipt') ?>','{{url('cash_receipt')}}','<?php echo csrf_token(); ?>')"
                                       name="search_cash_receipt" placeholder="Search Cash Receipt" >
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function getData(page){
        var searchVal = $('#search_cash_receipt').val();
        var pageData = '';
        if(searchVal == ''){
            pageData = '?page=' + page;
        }else{
            pageData = '<?php echo url('search_cash_receipt') ?>?page=' + page+'&searchVar='+searchVal;
        }
