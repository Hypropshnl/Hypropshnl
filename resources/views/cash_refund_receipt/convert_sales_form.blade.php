<form name="" id="convertSalesForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <div class="body">
                    ...
                    @if($po->account_id != '')
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td class="center-align" id="{{$po->unit_cost_trans}}">
                                <div class="form-group">
                                    <div style="cursor: pointer;" id="" onclick="tempItemDeleteConvert('itemId{{$po->id}}','<?php echo url('delete_refund_receipt_item_convert') ?>','{{$po->id}}','{{$po->extended_amount_trans}}','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','tax_amount_acc{{$num}}','discount_amount_acc{{$num}}','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','{{$po->po_id}}','<?php echo url('update_sum') ?>','reload_data','{{url('refund_receipt')}}','journal_extention')">
            ...
            <table class="table table-bordered table-hover table-striped" id="po_main_table_edit">
                ...
                <tr>
                    <td class="col-sm-4" id="hide_button_po_edit">
                        <div class="form-group">
                            <div onclick="addMore('add_more_po_edit','hide_button_po_edit','100','<?php echo URL::to('add_more'); ?>','get_inv_sales_edit','hide_button_po_edit');">
                                <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                            </div>
                        </div>
                    </td>
        ...
        <div class="row clearfix container">
            ...
            <div class="row clearfix">
                ...
                <textarea id="mail_message_sales" name="message" class="ckeditor" placeholder="Message">{{$edit->message}}</textarea>
                <script>
                    CKEDITOR.replace('mail_message_sales');
                </script>
