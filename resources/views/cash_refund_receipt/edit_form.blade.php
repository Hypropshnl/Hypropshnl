<form name="" id="editMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <div class="body">
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <div class="form-line">
                        ...
                        <input type="hidden" class="user_class" value="{{$edit->vendor_customer}}" name="pref_customer" id="vendorCust_edit" />
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    Billing Address
                    <div class="form-line">
                        <textarea class="form-control" readonly id="billing_address_edit" name="billing_address" placeholder="Billing Address">{{$edit->vendorCon->address}}</textarea>
                    </div>
                </div>
            </div>
        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="form-control" autocomplete="off" id="select_acc_refund_edit" onkeyup="searchOptionList('select_acc_refund_edit','myUL_refund_edit','{{url('default_select')}}','search_accounts','acc_refund_edit');" name="select_account" placeholder="Select Account">

                        <input type="hidden" value="" class=""  name="refund_from_account" id="acc_refund_edit" />
                    </div>
                </div>
                <ul id="myUL_refund_edit" class="myUL"></ul>
            </div>
            <div class="col-sm-4">
                Payment Method
                <div class="form-group">
                    <div class="form-line">
                        <select class="form-control" name="payment_method" >
                            <option value="{{$edit->id}}">{{$edit->transFormat->name}}</option>
                ...
                <div class="form-group">
                    <div class="form-line">
                        <select class="form-control " name="project" >
                            <option value="{{$edit->project_id}}">Project - {{$edit->projectData->project_name}}</option>
        ...
        <div class="row clearfix">
            ...
            <table class="table table-bordered table-hover table-striped" id="account_main_table_edit">
                ...
                @foreach($cashReceiptData as $po)

                    @if($po->account_id != '' && $po->main_trans == 1)
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class=" " name="item_desc_acc{{$num1}}" id="item_desc_acc{{$num}}" placeholder="Description">{{$po->trans_desc}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </td>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="{{$po->tax_perct}}" class=" shared_tax_perct_edit" name="tax_perct_acc{{$num1}}" id="tax_perct_acc{{$num}}" placeholder="Tax Percentage"
                                                   ...
                                                   onchange="percentToAmount('tax_perct_acc{{$num}}','tax_amount_acc{{$num}}','sub_total_acc{{$num}}','unit_cost_acc{{$num}}','acc500{{$num}}','','discount_amount_acc{{$num}}','tax_amount_acc{{$num}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount_edit','shared_discount_amount_edit','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit')">
                                                </div>
                                    </div>
                                </div>
                            </td>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="{{$po->discount_perct}}" class=" shared_discount_perct_edit" name="discount_perct_acc{{$num1}}" id="discount_perct_acc{{$num}}" placeholder="Discount Percentage"
                                                   ...
                                                   onchange="percentToAmount('discount_perct_acc{{$num}}','discount_amount_acc{{$num}}','sub_total_acc{{$num}}','unit_cost_acc{{$num}}','acc500{{$num}}','','discount_amount_acc{{$num}}','tax_amount_acc{{$num}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount_edit','shared_discount_amount_edit','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit')">
                                                </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="center-align" id="{{$po->unit_cost_trans}}">
                                <div class="form-group">
                                    <div style="cursor: pointer;" id="" onclick="permItemDelete('itemId{{$po->id}}','<?php echo url('delete_refund_receipt_item') ?>','{{$po->id}}','{{$po->extended_amount_trans}}','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','tax_amount_acc{{$num}}','discount_amount_acc{{$num}}','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','{{$po->extension_id}}','<?php echo url('update_sum') ?>','reload_data','{{url('refund_receipt')}}','journal_extention')">
                ...
                <tr>
                    <td class="center-align" id="hide_button_acc_edit">
                        <div class="form-group center-align">
                            <div onclick="addMore('add_more_acc_edit','hide_button_acc_edit','1000','<?php echo URL::to('add_more'); ?>','acc_edit','hide_button_acc_edit');">
        ...
        <div class="row clearfix">
            ...
            <table class="table table-bordered table-hover table-striped" id="po_main_table_edit">
                ...
                @foreach($cashReceiptData as $po)
                    ...
                    @if(!empty($po->item_id) && $po->main_trans == 1)
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class=" " name="item_desc{{$num2}}" id="item_desc{{$num}}" placeholder="Description">{{$po->trans_desc}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </td>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class=" " value="{{$po->quantity}}" name="quantity{{$num2}}" id="qty{{$num}}" placeholder="Quantity"
                                                   ...
                                                   onchange="itemSum('sub_total{{$num}}','unit_cost{{$num}}','inv500{{$num}}','qty{{$num}}','discount_amount{{$num}}','tax_amount{{$num}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','{{url('get_rate')}}','shared_tax_amount_edit','shared_discount_amount_edit','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','tax_perct{{$num}}','discount_perct{{$num}}')">
                                                </div>
                                    </div>
                                </div>
                            </td>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="{{$po->tax_perct}}" class=" shared_tax_perct_edit" name="tax_perct{{$num2}}" id="tax_perct{{$num}}" placeholder="Tax Percentage"
                                                   ...
                                                   onchange="percentToAmount('tax_perct{{$num}}','tax_amount{{$num}}','sub_total{{$num}}','unit_cost{{$num}}','inv500{{$num}}','qty{{$num}}','discount_amount{{$num}}','tax_amount{{$num}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount_edit','shared_discount_amount_edit','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit')">
                                                </div>
                                    </div>
                                </div>
                            </td>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="{{$po->discount_perct}}" class="  shared_discount_perct_edit" name="discount_perct{{$num2}}" id="discount_perct{{$num}}" placeholder="Discount Percentage"
                                                   ...
                                                   onchange="percentToAmount('discount_perct{{$num}}','discount_amount{{$num}}','sub_total{{$num}}','unit_cost{{$num}}','inv500{{$num}}','qty{{$num}}','discount_amount{{$num}}','tax_amount{{$num}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount_edit','shared_discount_amount_edit','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit')">
                                                </div>
                                    </div>
                                </div>
                            </td>
                ...
                <tr>
                    <td class="col-sm-4" id="hide_button_po_edit">
                        <div class="form-group">
                            <div onclick="addMore('add_more_po_edit','hide_button_po_edit','100000','<?php echo URL::to('add_more'); ?>','get_inv_sales_edit','hide_button_po_edit');">
                                <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                            </div>
                        </div>
                    </td>
        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="number" class="form-control" value="{{$edit->discount_perct}}" id="total_discount_perct_edit" 
                            onkeyup="genPercentage('total_discount_perct_edit','total_discount_amount_edit','overall_sum_edit','shared_sub_total_edit','vendorCust_edit','total_tax_amount_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','vendorCust_edit','posting_date_edit','shared_discount_amount_edit','shared_rate')"
                            onchange="genPercentage('total_discount_perct_edit','total_discount_amount_edit','overall_sum_edit','shared_sub_total_edit','vendorCust_edit','total_tax_amount_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','vendorCust_edit','posting_date_edit','shared_discount_amount_edit','shared_rate')"
                             name="one_time_discount_perct_edit" placeholder="Percentage" >
                        </div>
                    </div>
                </div>
        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="number" class="form-control" value="{{$edit->tax_perct}}" id="total_tax_perct_edit" 
                            onkeyup="genPercentageTax('total_tax_perct_edit','total_tax_amount_edit','overall_sum_edit','shared_sub_total_edit','vendorCust_edit','total_discount_amount_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','vendorCust_edit','posting_date_edit')"
                            onchange="genPercentageTax('total_tax_perct_edit','total_tax_amount_edit','overall_sum_edit','shared_sub_total_edit','vendorCust_edit','total_discount_amount_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','vendorCust_edit','posting_date_edit')"
                             name="one_time_discount_perct_edit" placeholder="Percentage" >
                        </div>
                    </div>
                </div>
        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                <div class="form-group">
                    Grand Total (Default Currency Incl. Tax) {{\App\Helpers\Utility::defaultCurrency()}}
                    <div class="form-line">
            ...
            <div class="col-sm-4 ">
                Grand Total(Incl. Tax) <span class="foreign_amount_edit">{{$edit->currency->code}}</span>
                <div class="form-group ">
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->trans_total}}" id="overall_sum_edit" readonly name="grand_total_vendor_curr" placeholder="Grand Total Customer Currency">
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                Grand Total(Excl. Tax) <span class="foreign_amount_edit">{{$edit->currency->code}}</span>
                <div class="form-group ">

                    <div class="form-line">
                        <input type="text" class="form-control" id="excl_overall_sum_edit" value="{{$exclTax}}" readonly name="" placeholder="Grand Total(Excl. Tax) Customer Currency">
                    </div>
                </div>
            </div>
        </div>
    ...
    <input type="hidden" name="convert_status" value="0" >
</form>
        ...
        @foreach($attach as $at)
            ...
            <tr id="removeAttach{{$num}}">
                ...
                <td>
                    ...
                    <button type="button"  onclick="removeMediaForm('removeAttach{{$num}}','removeAttachForm','<?php echo url('refund_receipt_remove_attachment'); ?>','reload_data',
                            '<?php echo url('refund_receipt'); ?>','<?php echo csrf_token(); ?>')"
