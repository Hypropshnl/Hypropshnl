        ...
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Refund Receipt</h4>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" autocomplete="off" id="select_acc_refund" onkeyup="searchOptionList('select_acc_refund','myUL_refund','{{url('default_select')}}','search_accounts','acc_refund');" name="select_account" placeholder="Select Account">
                    
                                            <input type="hidden" value="" class=""  name="refund_from_account" id="acc_refund" />
                                        </div>
                                    </div>
                                    <ul id="myUL_refund" class="myUL"></ul>
                                </div>
                                <div class="col-sm-4">
                                    Payment Method
                                    <div class="form-group">
                            ...
                            <div class="row clearfix">
                                <h4>Item Section</h4>
                                @include('includes.inventory_part_sales')
                            </div>
                            <hr/>
                            <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="overall_sum" readonly name="grand_total_vendor_curr" placeholder="Grand Total Customer Currency">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="excl_overall_sum" readonly name="" placeholder="Grand Total(Excl. Tax) Customer Currency">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaFormClass('createModal','createMainForm','<?php echo url('create_refund_receipt'); ?>','reload_data',
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('editModal','editMainForm','<?php echo url('edit_refund_receipt'); ?>','reload_data',
                            '<?php echo url('refund_receipt'); ?>','<?php echo csrf_token(); ?>',[
     ...
     <div class="modal fade" id="convertPoModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Convert to Refund Receipt</h4>
                    <li class="dropdown pull-right">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('convertPoModal','convertPoForm','<?php echo url('create_refund_receipt'); ?>','reload_data',
                            '<?php echo url('refund_receipt'); ?>','<?php echo csrf_token(); ?>',[
    ...
    <div class="modal fade" id="convertSalesModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('convertSalesModal','convertSalesForm','<?php echo url('create_refund_receipt'); ?>','reload_data',
                            '<?php echo url('refund_receipt'); ?>','<?php echo csrf_token(); ?>',[
                                'inv_class_edit','item_desc_edit','quantity_edit','unit_cost_edit','unit_measure_edit','tax_edit',
                            'tax_perct_edit','tax_amount_edit','discount_perct_edit','discount_amount_edit','sub_total_edit',
                            'acc_class_edit','acc_desc_edit','acc_rate_edit','acc_tax_edit','acc_tax_perct_edit',
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('refund_receipt'); ?>',
                                    '<?php echo url('delete_refund_receipt'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                ...
                <div class="body">
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <button style="cursor: pointer;" class="btn btn-info" onclick="convertForm('convertPo','convert_po_content','<?php echo url('convert_po_refund_receipt_form') ?>','<?php echo csrf_token(); ?>','convertPoModal','convert_sales_content')"><i class="fa fa-pencil-square-o "></i>Convert PO to Refund Receipt</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <button style="cursor: pointer;" class="btn btn-info" onclick="convertForm('convertSales','convert_sales_content','<?php echo url('convert_sales_refund_receipt_form') ?>','<?php echo csrf_token(); ?>','convertSalesModal','convert_po_content')"><i class="fa fa-pencil-square-o "></i>Convert Sales to Refund Receipt</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 ">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="search_refund_receipt" class="form-control"
                                       onkeyup="searchItem('search_refund_receipt','reload_data','<?php echo url('search_refund_receipt') ?>','{{url('refund_receipt')}}','<?php echo csrf_token(); ?>')"
                                       name="search_refund_receipt" placeholder="Search Refund Receipt" >
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function getData(page){
        var searchVal = $('#search_refund_receipt').val();
        var pageData = '';
        if(searchVal == ''){
            pageData = '?page=' + page;
        }else{
            pageData = '<?php echo url('search_refund_receipt') ?>?page=' + page+'&searchVar='+searchVal;
        }
