     ...
     <div class="modal fade" id="copyModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-lg">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Copy Content</h4>
                </div>
                <div class="modal-body" id="copy_content">

                    <div class="row">
                        <form name="import_excel" id="copyMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <b>Copy From Department</b>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <select  class="form-control " id="" name="copy_from_department" >
                                                    <option value="">Department</option>
                                                    @foreach($dept as $ap)
                                                        <option value="{{$ap->id}}">{{$ap->dept_name}}</option>
                                                    @endforeach
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <b>Copy From Position</b>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <select  class="form-control" name="copy_from_position" id="" >
                                                    <option value="">Position</option>
                                                    @foreach($position as $ap)
                                                        <option value="{{$ap->id}}">{{$ap->position_name}}</option>
                                                    @endforeach
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <b>Copy To Department</b>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <select  class="form-control" name="copy_to_department" >
                                                    <option value="">Department</option>
                                                    @foreach($dept as $ap)
                                                        <option value="{{$ap->id}}">{{$ap->dept_name}}</option>
                                                    @endforeach
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <b>Copy to Position</b>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <select  class="form-control" multiple name="copy_to_position[]" id="" >
                                                    <option value="">Position</option>
                                                    @foreach($position as $ap)
                                                        <option value="{{$ap->id}}">{{$ap->position_name}}</option>
                                                    @endforeach
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <b>Copy to Competency</b>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <select  class="form-control" name="copy_to_competency" id="" >
                                                    <option value="">Select Competencies</option>
                                                    <option value="{{Utility::ZERO}}">Technical and Behavioural</option>
                                                    <option value="{{Utility::TECH_COMP}}">Technical</option>
                                                    <option value="{{Utility::BEHAV_COMP}}">Behavioural</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaForm('copyModal','copyMainForm','<?php echo url('copy_comp_frame'); ?>','reload_data',
                            '<?php echo url('competency_framework'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-info waves-effect">
                        SAVE
                    </button>
                    <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button class="btn btn-success" data-toggle="modal" data-target="#copyModal"><i class="fa fa-plus"></i>Copy Competency</button>
                        </li>
                        <li>
