                    ...
                    @if($po->account_id != '')
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td class="center-align" id="{{$po->unit_cost_trans}}">
                                <div class="form-group">
                                    <div style="cursor: pointer;" id="" onclick="tempItemDeleteConvert('itemId{{$po->id}}','<?php echo url('delete_credit_memo_item_convert') ?>','{{$po->id}}','{{$po->extended_amount_trans}}','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','tax_amount_acc{{$num}}','discount_amount_acc{{$num}}','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','{{$po->po_id}}','<?php echo url('update_sum') ?>','reload_data','{{url('credit_memo')}}','journal_extention')">
