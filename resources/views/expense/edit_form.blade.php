            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <div class="form-line">
                        ...
                        <input type="hidden" value="" class=""  name="payment_account" id="acc_cash_edit" />
                    </div>
                </div>
            ...
            <table class="table table-bordered table-hover table-striped" id="po_main_table_edit">
                ...
                <tr>
                    <td class="col-sm-4" id="hide_button_po_edit">
                        <div class="form-group">
                            <div onclick="addMore('add_more_po_edit','hide_button_po_edit','100000','<?php echo URL::to('add_more'); ?>','get_inv_edit','hide_button_po_edit');">
                                <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                            </div>
                        </div>
                    </td>
        ...
        @foreach($attach as $at)
            ...
            <tr id="removeAttach{{$num}}">
                ...
                <td>
                    ...
                    <button type="button"  onclick="removeMediaForm('removeAttach{{$num}}','removeAttachForm','<?php echo url('expense_remove_attachment'); ?>','reload_data',
                            '<?php echo url('expense'); ?>','<?php echo csrf_token(); ?>')"
