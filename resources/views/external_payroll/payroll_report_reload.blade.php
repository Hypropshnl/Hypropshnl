        ...
        <tr>
            ...
            <td>
                @if($data->payroll_status == 1)
                    ...
                    <a style="cursor: pointer;" onclick="fetchHtml('{{$data->id}}','payroll_content','payrollModal','<?php echo url('external_payslip_item') ?>','<?php echo csrf_token(); ?>')">View</a>
                    @else
                    <a style="cursor: pointer;" onclick="fetchHtml('{{$data->id}}','payroll_content','payrollModal','<?php echo url('external_payslip_v2_item') ?>','<?php echo csrf_token(); ?>')">View</a>
                    @endif
                @endif
            </td>
