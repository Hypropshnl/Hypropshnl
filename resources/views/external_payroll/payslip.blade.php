                ...
                <div class="body table-responsive tbl_scroll" id="reload_data">
                    ...
                    <table class="table table-bordered table-hover table-striped" id="main_table">
                        ...
                        <tr>
                            ...
                            <td>
                                @if(empty($data->days_hours_engage))
                                <a style="cursor: pointer;" onclick="editForm('{{$data->id}}','edit_content','<?php echo url('external_payslip_item') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i>|View</a>
                                @else
                                <a style="cursor: pointer;" onclick="editForm('{{$data->id}}','edit_content','<?php echo url('external_payslip_v2_item') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i>|View</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
