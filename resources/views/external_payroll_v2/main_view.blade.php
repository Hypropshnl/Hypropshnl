            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox_payroll','reload_data','<?php echo url('external_payroll_v2'); ?>',
                                    '<?php echo url('delete_external_payroll_v2'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                ...
                <div class="body">
                    ...
                    <div class="row">
                        ...
                        <button type="button" onclick="processPayroll('kid_checkbox_payroll','reload_data','<?php echo url('external_payroll_v2'); ?>',
                            '<?php echo url('approve_external_payroll_v2'); ?>','<?php echo csrf_token(); ?>','1','payForm');" class="btn btn-success">
                    ...
                    <form name="searchOtherForm" id="searchOtherForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-3" id="" style="">
                                <div class="form-group">
                                    <button class="btn btn-info col-sm-8" type="button" onclick="searchReport('searchOtherForm','<?php echo url('search_external_payroll_v2_user_strict'); ?>','reload_data',
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="search_user" class="form-control"
                                        onkeyup="searchItem2('search_user','reload_data','<?php echo url('search_external_payroll_v2_user') ?>','{{url('external_payroll_v2')}}','<?php echo csrf_token(); ?>')"
                ...
                <form name="searchUsingDateForm" id="searchUsingDateForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-3" id="" style="">
                            <div class="form-group">
                                <button class="btn btn-info col-sm-8" type="button" onclick="searchUsingDate('searchUsingDateForm','<?php echo url('search_external_payroll_v2_lite'); ?>','reload_data',
