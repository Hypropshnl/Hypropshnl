        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="form-line">
                    ...
                    <select class="form-control comp_type_edit" id="comp_edit{{$num2}}"name="comp_type" >
                        <option value="">Select Type</option>
                        @foreach(\App\Helpers\Utility::COMPONENT_TYPE as $comp)
                            <option value="{{$comp}}">{{$comp}}</option>
                        @endforeach
...
@if($type == 'unit_goal')
    ...
    <div class="body card clearfix remove_unit_goal{{$more}} new_unit_goal">
            ...
            <div class="row clearfix">
                <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="file" class="form-control" multiple name="attachment[$num2][]" placeholder="Attachment">
                        </div>
                    </div>
                </div>
            </div>
...
@if($type == 'app_obj_goal')
    ...
    <div class=" body card clearfix remove_app_obj_goal{{$more}} new_app_obj_goal">
        ...
        <div class="row">
            <div class="col-md-3 addButtons" id="{{$hide_id}}{{$more}}">
                <div class="form-group">
...
@if($type == 'comp_assess')
    ...
    <div class="body card clearfix remove_comp_assess{{$more}} new_comp_assess">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <select class="form-control core_comp core_comp_edit" name="core_comp[]" id="core_comp{{$num2}}" onchange="fillNextInputParamGetVal('core_comp{{$num2}}','capable{{$num2}}','<?php echo url('default_select'); ?>','core_tech_comp','capable[]')" >
        ...
        <div>
            <div class="col-md-6 addButtons" id="{{$hide_id}}{{$more}}">
                <div class="form-group">
...
@if($type == 'behav_comp2')
     ...
     <div class="body card clearfix remove_behav_comp2{{$more}} new_behav_comp2">
        <div class="body clearfix">
            <div class="row clearfix">
                <div class="col-md-12">
                     <b>Core Behavioural Competency</b>
                    <div class="form-group">
                        <div class="form-line">
                            <select  class="form-control core_behav_comp core_behav_comp_edit" name="core_behav_comp[]" id="core_behav_comp{{$num2}}" onchange="fillNextInputParamGetVal('core_behav_comp{{$num2}}','element{{$num2}}','<?php echo url('default_select'); ?>','core_behav_comp','element[]')" >
...
<div class="row clearfix new_inv_bom remove_inv_bom{{$more}}"  >
    ...
    <div class="col-sm-4">
        ...
        <div class="form-group">
            <div class="form-line">
                <input type="number" class="form-control bom_qty  bom_qty_class" name="bom_qty" id="bom_qty{{$num2}}"
                 onkeyup="extendedAmount('inv{{$num2}}','{{url('ext_amount')}}','ext_amount{{$num2}}','bom_qty{{$num2}}','bom_qty_class','bom_amt','unit_cost')" 
                 onchange="extendedAmount('inv{{$num2}}','{{url('ext_amount')}}','ext_amount{{$num2}}','bom_qty{{$num2}}','bom_qty_class','bom_amt','unit_cost')" placeholder="Quantity" >
                </div>
        </div>
    </div>
...
@if($type == 'bom_inv_edit')
    <div class="row clearfix new_inv_bom remove_inv_bom{{$more}}"  >
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                <div class="form-line">
                    <input type="number" class="form-control bom_qty_edit bom_qty_class_edit" name="bom_qty" id="bom_qty{{$num2}}" 
                    onkeyup="extendedAmount('inv{{$num2}}','{{url('ext_amount')}}','ext_amount{{$num2}}','bom_qty{{$num2}}','bom_qty_class_edit','bom_amt_edit','unit_cost_edit')" 
                    onchange="extendedAmount('inv{{$num2}}','{{url('ext_amount')}}','ext_amount{{$num2}}','bom_qty{{$num2}}','bom_qty_class_edit','bom_amt_edit','unit_cost_edit')" placeholder="Quantity" >
                </div>
            </div>
        </div>
...
@if($type == 'assign_inv')
    ...
    <div class="body clearfix new_inv_assign remove_inv_assign{{$more}}">
        <div class="row clearfix ">
            <div class="col-sm-3">
                <div class="form-group">
                    <div class="form-line">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    <div class="form-line">
                        <input type="checkbox" class="affect_inventory" id="affect_inv{{$num2}}" onclick="toggleCheckBox('affect_inv{{$num2}}')" value="1" name="affect_inventory{{$num2}}" />Affect Inventory
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    <div class="form-line">
                    <input type="checkbox" name="change_option{{$num2}}" class="change_option" value="1" onclick="toggleInputInv('warehouse{{$num2}}','store{{$num2}}','change_view{{$num2}}');" id="change_view{{$num2}}" />Check to select Warehouse
                    </div>
                </div>
            </div>
        ...
        <div class="row clearfix">
            <div class="body" id="warehouse{{$num2}}" style="display: none;">
                <div class="col-sm-4">
                    <div class="form-group">
                        Warehouse
                        <div class="form-line" >
                            <select class=" from_warehouse" name="from_warehouse{{$num2}}" id="warehouse_id_from{{$num2}}" onchange="fillNextInputParamId('warehouse_id_from{{$num2}}','zone_display_id_from{{$num2}}','<?php echo url('default_select'); ?>','w_zones_fetch_extra','zone_id_from{{$num2}}','bin_id_from{{$num2}}')" >
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <b>Zone</b>
                        <div class="form-line" id="zone_display_id_from{{$num2}}">
                            <select class=" zones" id="zone_id_from" name="zone_id_from{{$num2}}" >
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <b>Bin</b>
                        <div class="form-line" id="bin_id_from{{$num2}}">
                            <select class=" bins" name="bin_id_from{{$num2}}"  >
            ...
            <div class="body" id="store{{$num2}}">
                <div class="col-sm-4">
                    <div class="form-group">
                        <div class="form-line">
                            <select  class="form-control store" name="store{{$num2}}" >
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <div class="form-line">
                        <textarea class="form-control desc" name="desc{{$num2}}" placeholder="Description"></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<div class="body clearfix new_store_items remove_store_items{{$more}}">
    <div class="row clearfix ">
        <div class="col-sm-4">
            <div class="form-group">
                <div class="form-line">
                    <input type="text" class="form-control" autocomplete="off" id="select_inv{{$num2}}" onkeyup="searchOptionList('select_inv{{$num2}}','myUL500{{$num2}}','{{url('default_select')}}','search_inventory','inv500{{$num2}}');" name="inventory_item" placeholder="Inventory Item">
    ...
    <div class="row clearfix">
        ...
        <div class=" addButtons" id="{{$hide_id}}{{$more}}">
            <div class="form-group">
                <div onclick="addMore('{{$add_id}}','{{$hide_id}}{{$more}}','{{$num2}}','<?php echo URL::to('add_more'); ?>','store_items','{{$hide_id}}');">
                    <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                </div>
            </div>
        </div>
        ...
        <div class="" id="">
            <div class="form-group">
                <div style="cursor: pointer;" onclick="removeInput('{{$add_id}}','remove_store_items{{$more}}','{{url('add_more')}}','store_items','new_store_items','{{$more}}','{{$add_id}}','{{$hide_id}}');">
                    <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                <div class="form-line">
                    <input type="number" class=" quantity " name="quantity" id="qty{{$num2}}" placeholder="Quantity"
                           ...
                           onchange="itemSum('sub_total{{$num2}}','unit_cost{{$num2}}','inv500{{$num2}}','qty{{$num2}}','discount_amount{{$num2}}','tax_amount{{$num2}}','shared_sub_total','overall_sum','foreign_overall_sum','<?php echo url('amount_to_default_curr') ?>','{{url('get_rate')}}','shared_tax_amount','shared_discount_amount','total_tax_amount','total_discount_amount','vendorCust','posting_date','tax_perct{{$num2}}','discount_perct{{$num2}}')">
                        </div>
            </div>
        </div>
    </td>
            ...
            <div class="form-group">
                <div class="form-line">
                    <input type="number" class=" unit_cost " name="unit_cost" id="unit_cost{{$num2}}" placeholder="Unit Cost/Rate"
                           ...
                           onchange="itemSum('sub_total{{$num2}}','unit_cost{{$num2}}','inv500{{$num2}}','qty{{$num2}}','discount_amount{{$num2}}','tax_amount{{$num2}}','shared_sub_total','overall_sum','foreign_overall_sum','<?php echo url('amount_to_default_curr') ?>','','shared_tax_amount','shared_discount_amount','total_tax_amount','total_discount_amount','vendorCust','posting_date','tax_perct{{$num2}}','discount_perct{{$num2}}')">
                        </div>
            </div>
        </div>
    </td>
            ...
            <div class="form-group">
                <div class="form-line">
                    <input type="number" class=" tax_perct " name="tax_perct" id="tax_perct{{$num2}}" placeholder="Tax Percentage"
                           ...
                           onchange="percentToAmount('tax_perct{{$num2}}','tax_amount{{$num2}}','sub_total{{$num2}}','unit_cost{{$num2}}','inv500{{$num2}}','qty{{$num2}}','discount_amount{{$num2}}','tax_amount{{$num2}}','shared_sub_total','overall_sum','foreign_overall_sum','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount','shared_discount_amount','total_tax_amount','total_discount_amount','vendorCust','posting_date')">
                        </div>
            </div>
        </div>
    </td>
            ...
            <div class="form-group">
                <div class="form-line">
                    <input type="number" class=" discount_perct " name="discount_perct" id="discount_perct{{$num2}}" placeholder="Discount Percentage"
                           ...
                           onchange="percentToAmount('discount_perct{{$num2}}','discount_amount{{$num2}}','sub_total{{$num2}}','unit_cost{{$num2}}','inv500{{$num2}}','qty{{$num2}}','discount_amount{{$num2}}','tax_amount{{$num2}}','shared_sub_total','overall_sum','foreign_overall_sum','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount','shared_discount_amount','total_tax_amount','total_discount_amount','vendorCust','posting_date')">
                        </div>
            </div>
        </div>
    </td>
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <select class="store " name="store" >
                            <option value="">Ship From Store</option>
                            @foreach($store as $inv)
                                <option value="{{$inv->id}}">{{$inv->name}} ({{$inv->code}})</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class=" shared_rate acct_rate " name="unit_cost" id="unit_cost_acc{{$num2}}" placeholder="Rate/Cost Amount"
                               ...
                               onchange="accountSum('sub_total_acc{{$num2}}','acc500{{$num2}}','unit_cost_acc{{$num2}}','discount_amount_acc{{$num2}}','tax_amount_acc{{$num2}}','shared_sub_total','overall_sum','foreign_overall_sum','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount','shared_discount_amount','total_tax_amount','total_discount_amount','vendorCust','posting_date','tax_perct_acc{{$num2}}','discount_perct_acc{{$num2}}')">
                            </div>
                </div>
            </div>
        </td>
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class=" acc_tax_perct shared_tax_perct " name="tax_perct" id="tax_perct_acc{{$num2}}" placeholder="Tax Percentage"
                               ...
                               onchange="percentToAmount('tax_perct_acc{{$num2}}','tax_amount_acc{{$num2}}','sub_total_acc{{$num2}}','unit_cost_acc{{$num2}}','acc500{{$num2}}','','discount_amount_acc{{$num2}}','tax_amount_acc{{$num2}}','shared_sub_total','overall_sum','foreign_overall_sum','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount','shared_discount_amount','total_tax_amount','total_discount_amount','vendorCust','posting_date')">
                            </div>
                </div>
            </div>
        </td>
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class=" acc_discount_perct shared_discount_perct " name="discount_perct" id="discount_perct_acc{{$num2}}" placeholder="Discount Percentage"
                               ...
                               onchange="percentToAmount('discount_perct_acc{{$num2}}','discount_amount_acc{{$num2}}','sub_total_acc{{$num2}}','unit_cost_acc{{$num2}}','acc500{{$num2}}','','discount_amount_acc{{$num2}}','tax_amount_acc{{$num2}}','shared_sub_total','overall_sum','foreign_overall_sum','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount','shared_discount_amount','total_tax_amount','total_discount_amount','vendorCust','posting_date')">
                            </div>
                </div>
            </div>
        </td>
    ...
    <tr class="row clearfix new_po_edit remove_po_edit{{$more}}">
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <select class=" store store_edit" name="store" >
                            <option value="">Select Receipt Store</option>
                            @foreach($store as $inv)
                                <option value="{{$inv->id}}">{{$inv->name}} ({{$inv->code}})</option>
                            @endforeach
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class=" quantity quantity_edit" name="quantity" id="qty{{$num2}}" placeholder="Quantity"
                               ...
                               onchange="itemSum('sub_total{{$num2}}','unit_cost{{$num2}}','inv500{{$num2}}','qty{{$num2}}','discount_amount{{$num2}}','tax_amount{{$num2}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','{{url('get_rate')}}','shared_tax_amount_edit','shared_discount_amount_edit','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','tax_perct{{$num2}}','discount_perct{{$num2}}')">
                            </div>
                </div>
            </div>
        </td>
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class=" tax_perct tax_perct_edit" name="tax_perct" id="tax_perct{{$num2}}" placeholder="Tax Percentage"
                               ...
                               onchange="percentToAmount('tax_perct{{$num2}}','tax_amount{{$num2}}','sub_total{{$num2}}','unit_cost{{$num2}}','inv500{{$num2}}','qty{{$num2}}','discount_amount{{$num2}}','tax_amount{{$num2}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount_edit','shared_discount_amount_edit','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit')">
                            </div>
                </div>
            </div>
        </td>
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class=" discount_perct discount_perct_edit" name="discount_perct" id="discount_perct{{$num2}}" placeholder="Discount Percentage"
                               ...
                               onchange="percentToAmount('discount_perct{{$num2}}','discount_amount{{$num2}}','sub_total{{$num2}}','unit_cost{{$num2}}','inv500{{$num2}}','qty{{$num2}}','discount_amount{{$num2}}','tax_amount{{$num2}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','shared_tax_amount_edit','shared_discount_amount_edit','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit')">
                            </div>
                </div>
            </div>
        </td>
    ...
    <tr class="row clearfix new_sales_edit remove_sales_edit{{$more}}">
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <select class="  store_edit" name="store" >
                            <option value="">Ship From Store</option>
                            @foreach($store as $inv)
                                <option value="{{$inv->id}}">{{$inv->name}} ({{$inv->code}})</option>
                            @endforeach
    ...
    <tr class="row clearfix new_acc_rfq remove_acc_rfq{{$more}}">
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <textarea class="acc_desc " name="acc_desc" id="item_desc{{$num2}}" placeholder="Description"></textarea>
                    </div>
                </div>
            </div>
        </td>
...
@endif
<!-- END OF RFQ ACCOUNT PART -->

<!-- BEGIN OF RFQ ACCOUNT PART EDIT -->
@if($type == 'acc_rfq_edit')
    <tr class="row clearfix new_acc_rfq_edit remove_acc_rfq_edit{{$more}}">
        ...
        <td class=" addButtons center-align" id="{{$hide_id}}{{$more}}">
            <div class="form-group">
                <div onclick="addMore('{{$add_id}}','{{$hide_id}}{{$more}}','{{$num2}}','<?php echo URL::to('add_more'); ?>','acc_rfq_edit','{{$hide_id}}');">
                    <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                </div>
            </div>
        </td>
        ...
        <td class="center-align" id="">
            <div class="form-group">
                <div style="cursor: pointer;" onclick="removeInput('{{$add_id}}','remove_acc_rfq_edit{{$more}}','{{url('add_more')}}','acc_rfq_edit','new_acc_rfq_edit','{{$more}}','{{$add_id}}','{{$hide_id}}');">
                    <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                </div>
            </div>
        </td>
    ...
    <tr class="row clearfix new_rfq remove_rfq{{$more}}">
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="" autocomplete="off" id="select_inv{{$num2}}" onkeyup="searchOptionListInvDetail('select_inv{{$num2}}','myUL500{{$num2}}','{{url('default_select')}}','search_inventory_detail','inv500{{$num2}}','item_desc{{$num2}}','unit_cost{{$num2}}','unit_measure{{$num2}}','qty{{$num2}}','{{\App\Helpers\Utility::PURCHASE_DESC}}');" name="select_user" placeholder="Inventory Item">
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <select name="unit_measure"  class="unit_measure" id="" id="unit_measure{{$num2}}" >
...
<!-- BEGIN OF RFQ EDIT -->
@if($type == 'rfq_edit')
    <tr class="row clearfix new_rfq_edit remove_rfq_edit{{$more}}">

        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="" autocomplete="off" id="select_inv{{$num2}}" onkeyup="searchOptionListInvDetail('select_inv{{$num2}}','myUL500{{$num2}}','{{url('default_select')}}','search_inventory_detail','inv500{{$num2}}','item_desc_edit{{$num2}}','unit_cost{{$num2}}','unit_measure{{$num2}}','qty_edit{{$num2}}','{{\App\Helpers\Utility::PURCHASE_DESC}}');" name="select_user" placeholder="Inventory Item">
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <textarea class="item_desc_edit" name="item_desc_edit" id="item_desc_edit{{$num2}}" placeholder="Description"></textarea>
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class="quantity_edit" name="quantity_edit" id="qty_edit{{$num2}}" placeholder="Quantity" />
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <select name="unit_measure"  class="unit_measure_edit" id="" id="unit_measure{{$num2}}" >
                            <option value="">Select Unit OF measurement</option>
                            @foreach($unitMeasure as $data)
                                <option value="{{$data->unit_name}}">{{$data->unit_name}}</option>
                            @endforeach
        ...
        <td class=" addButtons center-align" id="{{$hide_id}}{{$more}}">
            <div class="form-group">
                <div onclick="addMore('{{$add_id}}','{{$hide_id}}{{$more}}','{{$num2}}','<?php echo URL::to('add_more'); ?>','rfq_edit','{{$hide_id}}');">
                    <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                </div>
            </div>
        </td>
        ...
        <td class="center-align" id="">
            <div class="form-group">
                <div style="cursor: pointer;" onclick="removeInputCalc('{{$add_id}}','remove_rfq_edit{{$more}}','{{url('add_more')}}','rfq_edit','new_rfq_edit','{{$more}}','{{$add_id}}','{{$hide_id}}');">
                    <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                </div>
            </div>
        </td>
...
<!-- BEGIN OF MULTIPLE APPRAISAL Rating SCORES -->
@if($type == 'multiple_rating_scores')

    <div class="row clearfix new_multiple_rating_scores remove_multiple_rating_scores{{$more}}" style="margin-left:5px;">

        <div class="row clearfix">
            <div class="col-sm-4" id="">
                <div class="form-group">
                    <div class="form-line">
                        <select class="form-control rating" name="rating[]" id="">
                            <option value="">Select Rating</option>
                            @foreach($appraisalRec as $rec)
            ...
            <div class="col-sm-1 addButtons" id="{{$hide_id}}{{$more}}">
                <div class="form-group">
                    <div onclick="addMore('{{$add_id}}','{{$hide_id}}{{$more}}','{{$num2}}','<?php echo URL::to('add_more'); ?>','multiple_rating_scores','{{$hide_id}}');">
                        <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-1" id="">
                <div class="form-group">
                    <div style="cursor: pointer;" onclick="removeInput('{{$add_id}}','remove_multiple_rating_scores{{$more}}','{{url('add_more')}}','multiple_rating_scores','new_multiple_rating_scores','{{$more}}','{{$add_id}}','{{$hide_id}}');">
                        <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                    </div>
                </div>
            </div>
...
@endif
<!-- END OF MULTIPLE APPRAISAL Rating SCORES -->

<!-- BEGIN OF MULTIPLE APPRAISAL Rating SCORES EDIT -->
@if($type == 'multiple_rating_scores_edit')

    <div class="row clearfix new_multiple_rating_scores_edit remove_multiple_rating_scores{{$more}}" style="margin-left:5px;">

        <div class="row clearfix">
            <div class="col-sm-4" id="">
                <div class="form-group">
                    <div class="form-line">
                        <select class="form-control rating_edit" name="rating[]" id="">
                            <option value="">Select Rating</option>
                            @foreach($appraisalRec as $rec)
                                <option value="{{$rec->id}}">{{$rec->name}}</option>
                            @endforeach
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class="low_score_class_edit" name="low_score[]" placeholder="Enter Low Score" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class="high_score_class_edit" name="high_score[]" placeholder="Enter High Score" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-1 addButtons" id="{{$hide_id}}{{$more}}">
                <div class="form-group">
                    <div onclick="addMore('{{$add_id}}','{{$hide_id}}{{$more}}','{{$num2}}','<?php echo URL::to('add_more'); ?>','multiple_rating_scores_edit','{{$hide_id}}');">
                        <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-1" id="">
                <div class="form-group">
                    <div style="cursor: pointer;" onclick="removeInput('{{$add_id}}','remove_multiple_rating_scores{{$more}}','{{url('add_more')}}','multiple_rating_scores_edit','new_multiple_rating_scores_edit','{{$more}}','{{$add_id}}','{{$hide_id}}');">
                        <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                    </div>
                </div>
            </div>
...
@endif
<!-- END OF MULTIPLE APPRAISAL Rating SCORES EDIT -->

<!-- BEGIN OF MULTIPLE USER SCORES -->
@if($type == 'multiple_user_scores')

    <div class="row clearfix new_multiple_user_scores remove_multiple_user_scores{{$more}}" style="margin-left:5px;">

        <div class="row clearfix">
            <div class="col-sm-5" id="">
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="form-control" autocomplete="off" id="select_user{{$num2}}" onkeyup="searchOptionList('select_user{{$num2}}','myUL1{{$num2}}','{{url('default_select')}}','default_search','user{{$num2}}');" name="select_user" placeholder="Select Reviewer">

                        <input type="hidden" class="user_class" name="reviewer[]" id="user{{$num2}}" />
                    </div>
                </div>
                <ul id="myUL1{{$num2}}" class="myUL"></ul>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class="score_class" name="score[]" placeholder="Enter Score" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-1 addButtons" id="{{$hide_id}}{{$more}}">
                <div class="form-group">
                    <div onclick="addMore('{{$add_id}}','{{$hide_id}}{{$more}}','{{$num2}}','<?php echo URL::to('add_more'); ?>','multiple_user_scores','{{$hide_id}}');">
                        <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-1" id="">
                <div class="form-group">
                    <div style="cursor: pointer;" onclick="removeInput('{{$add_id}}','remove_multiple_user_scores{{$more}}','{{url('add_more')}}','multiple_user_scores','new_multiple_user_scores','{{$more}}','{{$add_id}}','{{$hide_id}}');">
                        <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                    </div>
                </div>
            </div>
...
@endif
<!-- END OF MULTIPLE USER SCORES -->

<!-- BEGIN OF MULTIPLE USER SCORES EDIT -->
@if($type == 'multiple_user_scores_edit')

    <div class="row clearfix new_multiple_user_scores_edit remove_multiple_user_scores_edit{{$more}}" style="margin-left:5px;">

        <div class="row clearfix">
            <div class="col-sm-5" id="">
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="form-control" autocomplete="off" id="select_user_edit{{$num2}}" onkeyup="searchOptionList('select_user_edit{{$num2}}','myUL1{{$num2}}','{{url('default_select')}}','default_search','user_edit{{$num2}}');" name="select_user" placeholder="Select Reviewer">

                        <input type="hidden" class="user_class_edit" name="reviewer_edit[]" id="user_edit{{$num2}}" />
                    </div>
                </div>
                <ul id="myUL1{{$num2}}" class="myUL"></ul>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class="score_class_edit" name="score_edit[]" placeholder="Enter Score" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-1 addButtons" id="{{$hide_id}}{{$more}}">
                <div class="form-group">
                    <div onclick="addMore('{{$add_id}}','{{$hide_id}}{{$more}}','{{$num2}}','<?php echo URL::to('add_more'); ?>','multiple_user_scores_edit','{{$hide_id}}');">
                        <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-1" id="">
                <div class="form-group">
                    <div style="cursor: pointer;" onclick="removeInput('{{$add_id}}','remove_multiple_user_scores_edit{{$more}}','{{url('add_more')}}','multiple_user_scores_edit','new_multiple_user_scores_edit','{{$more}}','{{$add_id}}','{{$hide_id}}');">
                        <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                    </div>
                </div>
            </div>
...
@endif
<!-- END OF MULTIPLE USER SCORES EDIT -->
...
<!-- START OF ADDING ZONES TO WAREHOUSE -->
@if($type == 'inventory_sub_category')
    <div class="row clearfix new_inventory_sub_category remove_inventory_sub_category{{$more}}"  >
        
        <div class="col-sm-12">
            <b>Subcategory</b>
            <div class="form-group">
                <div class="form-line">
                    <input type="text" class="inventory_sub_category form-control" name="name{{$num2}}" placeholder="Subcategory Name">
                </div>
            </div>
        </div>
        ...
        <div class=" addButtons" id="{{$hide_id}}{{$more}}">
            <div class="form-group">
                <div onclick="addMore('{{$add_id}}','{{$hide_id}}{{$more}}','{{$num2}}','<?php echo URL::to('add_more'); ?>','inventory_sub_category','{{$hide_id}}');">
                    <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                </div>
            </div>
        </div>
        ...
        <div class="" id="">
            <div class="form-group">
                <div style="cursor: pointer;" onclick="removeInput('{{$add_id}}','remove_inventory_sub_category{{$more}}','{{url('add_more')}}','inventory_sub_category','new_inventory_sub_category','{{$more}}','{{$add_id}}','{{$hide_id}}');">
                    <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                </div>
            </div>
        </div>
...
@endif
<!-- END OF ADDING END OF ADDING SUBCATEGORY TO INVENTORY CATEGORY -->
