                        ...
                        <div class="body container">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control timepicker" name="occurrence time" placeholder="Occurrence Time">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea type="text" class="form-control " name="actions_taken" placeholder="Actions Taken">Enter Actions Taken</textarea>                                           
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <h2>Section 2, to be completed by Quality, Healthy, Safety and Environment Department</h2>
                            </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <?php $companyInfo = \App\Helpers\Utility::companyInfo(); ?>
                    ...
                    <h3>{{$companyInfo->name}} HSE REPORT Form</h3>
                    @endif
                    @include('includes.qr_code_link',['dataId'=> '', 'type' => 'hse_report_form'])
                </div>
                <div class="modal-footer">
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button class="btn btn-success" data-toggle="modal" data-target="#qrModal"><i class="fa fa-eye"></i>QR CODE</button>
                        </li>
                        <li>
