...
@section('content')
    ...
    <div class="modal fade" id="attachModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="attach_content" style="height:400px; overflow:scroll;">


                </div>
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormRequest('attachModal','attachForm','<?php echo url('hse_report_response'); ?>','reload_data',
                            '<?php echo url('all_hse_report'); ?>','<?php echo csrf_token(); ?>','causes','search_hse_button')"
    ...
    <script>
        ...
        function submitMediaFormRequest(formModal,formId,submitUrl,reload_id,reloadUrl,token,editorId,searchButtonId){
            ...
            postVars.append('causes',ckInput);
