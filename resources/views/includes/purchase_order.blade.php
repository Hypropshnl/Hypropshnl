    ...
    <tr>
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" readonly class=" unit_measure"  name="unit_measure" id="unit_measure" placeholder="Unit Measure" >
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <input type="date" class=" planned" name="planned_date" placeholder="Planned Date" required>
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <input type="date" class=" expected" name="expected_date" placeholder="Expected Date" required>
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <input type="date" class=" promised" name="promised_date" placeholder="Promised Date" required>
                    </div>
                </div>
            </div>
        </td>
