    ...
    <div class="body">
        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->vendor->name}}" autocomplete="off" id="select_vendor" onkeyup="searchOptionList('select_vendor','myUL10','{{url('default_select')}}','search_vendor','vendor');" name="select_user" placeholder="Select Vendor">

                        <input type="hidden" value="{{$edit->pref_vendor}}" class="user_class" name="pref_vendor" id="vendor" />
                    </div>
                </div>
