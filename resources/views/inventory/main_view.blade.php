        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Import Inventory</h4>
                </div>
                <div class="modal-body" style="height:400px; overflow:scroll;">

                    <form name="createMainForm" id="importMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="body">
                            <h3>General</h3><hr>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="hidden" class="acc_class" value="" name="expense_account" id="acc1" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="hidden" class="acc_class" value="" name="income_account" id="acc2" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="hidden" class="acc_class" value="" name="inventory_account" id="acc3" />
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaForm('importModal','importMainForm','<?php echo url('import_inventory'); ?>','reload_data',
                            '<?php echo url('inventory'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" autocomplete="off" id="select_user" onkeyup="searchOptionList('select_user','myUL12','{{url('default_select')}}','search_vendor','vendor');" name="select_user" placeholder="Preferred Vendor">

                                            <input type="hidden" class="user_class" name="pref_vendor" id="vendor" />
                                        </div>
                                    </div>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button class="btn btn-success" data-toggle="modal" data-target="#importModal"><i class="fa fa-file"></i>Import</button>
                        </li>
                        <li>
                ...
                <div class=" table-responsive tbl_scroll" id="reload_data" style="height:500px; overflow:scroll;">
                    <table class="table table-bordered table-hover table-striped" id="main_table">
                        ...
                        <tr>
                            ...
                            <td>@include('includes.qr_code_link',['dataId'=>$data->id, 'type' => 'inventory'])</td>
                            <td>
