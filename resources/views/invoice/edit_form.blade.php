            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <div class="form-line">
                        ...
                        <option value="{{$edit->terms}}">{{$edit->transTerms->name}}</option>
                ...
                <tr>
                    <td class="center-align" id="hide_button_acc_edit">
                        <div class="form-group center-align">
                            <div onclick="addMore('add_more_acc_edit','hide_button_acc_edit','10000','<?php echo URL::to('add_more'); ?>','acc_edit','hide_button_acc_edit');">
        ...
        @foreach($attach as $at)
            ...
            <tr id="removeAttach{{$num}}">
                ...
                <td>
                    ...
                    <button type="button"  onclick="removeMediaForm('removeAttach{{$num}}','removeAttachForm','<?php echo url('invoice_remove_attachment'); ?>','reload_data',
                            '<?php echo url('invoice'); ?>','<?php echo csrf_token(); ?>')"
