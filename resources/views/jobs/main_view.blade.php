                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="datepicker form-control" name="closing_date" placeholder="Closing Date" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="6" class=" form-control" name="keywords" placeholder="Keywords(e.g sales, procurement, marketing) use comma to separate keywords. Keywords are weighted from low to high in order of importance from left to right " ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" name="weighted_score" placeholder="Enter Pass Score" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select type="text" class="form-control" name="action_taken" >
                                                <option value="0">Action Taken</option>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body table-responsive" id="reload_data">
                    <h5>Job Application Page Url -- <a href="{{url('OByxRFDeOtxHYxnTTfJmSukkJZ7aCY/positions/2y101HS5A2C30Nex/available')}}" target="_blank">{{url('OByxRFDeOtxHYxnTTfJmSukkJZ7aCY/positions/2y101HS5A2C30Nex/available')}}</a></h5>
                    <hr/>
