            ...
            <div class="modal-content">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="hidden" class="user_class" name="user_id" id="user2" />
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaForm('createModal','createMainForm','<?php echo url('create_leave'); ?>','reload_data',
                            '<?php echo url('leave_history'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
                    ...
                    <div class="row">
                        <form name="searchMainForm" id="searchMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-3" id="">
                                <div class="form-group">
                                    <div class="form-line">
                                        <select  class="form-control show-tick" multiple id="leave_type" name="leave_type[]" data-selected-text-format="count">
                                            <option value="">Leave Type (Multiple)</option>
                                            @foreach($leaveType as $ap)
                                                <option value="{{$ap->id}}">{{$ap->leave_type}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <button class="btn btn-info" type="button" onclick="searchReport('searchMainForm','<?php echo url('search_leave_log'); ?>','reload_data',
                        ...
                        <div class="table-responsive tbl_scroll" id="reload_data">
                            <table class="table table-bordered table-hover table-striped" id="main_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="cursor: pointer;" onclick="fetchHtml('{{$data->request_user}}','leave_status_display','leaveStatusModal','<?php echo url('user_leave_status') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-eye fa-2x"></i></a>
                                    </td>
                                    <td>
