        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li>
                            <button class="btn btn-info" onclick="fetchHtml('','leave_status_display','leaveStatusModal','<?php echo url('my_leave_status') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-eye fa-2x"></i>My Leave Status</button>
                        </li>
                        <li>
