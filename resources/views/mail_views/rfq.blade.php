...
@section('content')
    ...
    <table>
        <thead>
            <th>All quotations must be submitted exclusively via the link below. Email submissions will not be accepted.</th>
        </thead>
        <tbody>
            <tr>
                <td><a href='{{$rfqUrl}}'>Click here to submit your Quote</a></td>
            </tr>
            <tr>
                <td><a href='{{$rfqUrl}}'>{{$rfqUrl}}</a></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table table-responsive">
        ...
        <tr>
            ...
            <td>RFQ Due Date: {{$itemDetail->due_date_time}}</td>
        </tr>
        </tbody>
    </table><hr/>
