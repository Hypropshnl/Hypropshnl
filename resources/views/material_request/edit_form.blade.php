        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    MR Number
                    <div class="form-line">
                        <input type="text" class="form-control" name="mr_number" value="{{$edit->mr_number}}" placeholder="MR Number">
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                    ...
                    @if($po->account_id != '')
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td class="center-align" id="">
                                <div class="form-group">
                                    <div style="cursor: pointer;" id="" onclick="permDeleteData('itemId{{$po->id}}','<?php echo url('delete_material_request_item') ?>','{{$po->id}}')" >
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class=" " name="item_desc{{$num2}}" id="item_desc_edit{{$num}}" placeholder="Description">{{$po->mr_desc}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </td>
    ...
    <table class="table table-responsive">
        ...
        @foreach($attach as $at)
            ...
            <tr id="removeAttach{{$num}}">
                <td>File{{$num}}</td>
                <td><a target="_blank" href="<?php echo URL::to('material_request_download_attachment?file='); ?>{{$at}}">
