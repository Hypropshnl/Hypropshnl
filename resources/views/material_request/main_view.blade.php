        ...
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Material Request (Request for Quote)</h4>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        Assign User
                                        <div class="form-line">
                                            <input type="text" class="form-control" readonly autocomplete="off" id="select_user" onkeyup="searchOptionList('select_user','myUL2','{{url('default_select')}}','default_search','assign_user');" name="select_user" placeholder="Select User">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        Material Request Number (MR)
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="mr_number" placeholder="Material Number (MR)">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaFormClass('createModal','createMainForm','<?php echo url('create_material_request'); ?>','reload_data',
                            '<?php echo url('material_request'); ?>','<?php echo csrf_token(); ?>',[
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('editModal','editMainForm','<?php echo url('edit_material_request'); ?>','reload_data',
                            '<?php echo url('material_request'); ?>','<?php echo csrf_token(); ?>',[
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('material_request'); ?>',
                                    '<?php echo url('delete_material_request'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                ...
                <div class="row">
                    <div class="col-sm-12 ">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="search_mr" class="form-control"
                                       onkeyup="searchItem('search_mr','reload_data','<?php echo url('search_material_request') ?>','{{url('material_request')}}','<?php echo csrf_token(); ?>')"
                                       name="search_mr" placeholder="Search Material Request (MR)" >
                            </div>
                        </div>
                    </div>
                </div>
