...
@section('content')
    ...
    <!-- RESPONSE MODAL -->
     @include('includes/general_response_form',[$submitUrl = 'material_request_response', $reloadUrl = 'my_material_request_requests', $itemClass = 'kid_checkbox'])
        ...
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="submitDefault('editMiniModal','editMiniForm','<?php echo url('edit_material_request_mini'); ?>','reload_data',
                            '<?php echo url('my_material_request_requests'); ?>','<?php echo csrf_token(); ?>')"
     ...
     <div class="modal fade" id="attachModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaForm('attachModal','attachForm','<?php echo url('edit_material_request_attachment'); ?>','reload_data',
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_material_request_requests'); ?>',
                                    '<?php echo url('approve_material_request'); ?>','<?php echo csrf_token(); ?>','1');" class="btn btn-success">
                        ...
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_material_request_requests'); ?>',
                                    '<?php echo url('approve_material_request'); ?>','<?php echo csrf_token(); ?>','0');" class="btn btn-danger">
