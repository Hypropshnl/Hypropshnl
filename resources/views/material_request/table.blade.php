<table class="table table-bordered table-hover table-striped" id="main_table">
    ...
    @foreach($mainData as $data)
        <tr>
            ...
            <td>
                <a style="cursor: pointer;" onclick="editForm('{{$data->id}}','edit_content','<?php echo url('edit_material_request_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
            </td>
            <td>
