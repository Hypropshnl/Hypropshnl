            ...
            <div class="card">
                    ...
                    <form name="searchOtherForm" id="searchOtherForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-3" id="" style="">
                                <div class="form-group">
                                    <button class="btn btn-info col-sm-8" type="button" onclick="searchReport('searchOtherForm','<?php echo url('search_payroll_user_strict'); ?>','reload_data',
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="search_user" class="form-control"
                                        onkeyup="searchItem2('search_user','reload_data','<?php echo url('search_payroll_user') ?>','{{url('payroll')}}','<?php echo csrf_token(); ?>')"
                ...
                <form name="searchUsingDateForm" id="searchUsingDateForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-3" id="" style="">
                            <div class="form-group">
                                <button class="btn btn-info col-sm-8" type="button" onclick="searchUsingDate('searchUsingDateForm','<?php echo url('search_payroll_lite'); ?>','reload_data',
                ...
                <div class="body table-responsive tbl_scroll" id="reload_data">
                    ...
                    <table class="table table-bordered table-hover table-striped tbl_order" id="main_table">
                        ...
                        <tr>
                            ...
                            <th>Earning/Deduction {{\App\Helpers\Utility::defaultCurrency()}}</th>
                            <th>Earning/Deduction Desc</th>
