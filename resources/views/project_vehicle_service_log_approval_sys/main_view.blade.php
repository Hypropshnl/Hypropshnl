        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Project Vehicle Work Order Approval System</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button onclick="saveApprovalSys('createModal','createMainForm','<?php echo url('create_project_vehicle_service_log_approval'); ?>','reload_data',
                            '<?php echo url('project_vehicle_service_log_approval_system'); ?>','<?php echo csrf_token(); ?>','user_class','stage')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button onclick="saveApprovalSys('editModal','editMainForm','<?php echo url('edit_project_vehicle_service_log_approval'); ?>','reload_data',
                            '<?php echo url('project_vehicle_service_log_approval_system'); ?>','<?php echo csrf_token(); ?>','user_class_edit','stage_edit')" type="button" class="btn btn-link waves-effect">
                        SAVE CHANGES
                    </button>
                    <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                </div>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Project Vehicle Work Order Approval System
                    </h2>
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('project_vehicle_service_log_approval_system'); ?>',
                                    '<?php echo url('delete_project_vehicle_service_log_approval'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                ...
                <div class="body table-responsive" id="reload_data">
                    <table class="table table-bordered table-hover table-striped" id="main_table">
                        ...
                        <tr>
                            ...
                            <td>
                                <a style="cursor: pointer;" onclick="editForm('{{$data->id}}','edit_content','<?php echo url('edit_project_vehicle_service_log_approval_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
