<form name="" id="editMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <div class="body">
            ...
            <table class="table table-bordered table-hover table-striped" id="po_main_table_edit">
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="  " value="{{$po->planned_receipt_date}}" name="planned_date{{$num2}}" placeholder="Planned Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="  " value="{{$po->expected_receipt_date}}" name="expected_date{{$num2}}" placeholder="Expected Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="  " value="{{$po->promised_receipt_date}}" name="promised_date{{$num2}}" placeholder="Promised Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                ...
                <tr>
                    <td class="col-sm-4" id="hide_button_po_edit">
                        <div class="form-group">
                            <div onclick="addMore('add_more_po_edit','hide_button_po_edit','100000','<?php echo URL::to('add_more'); ?>','po_edit','hide_button_po_edit');">
                                <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                            </div>
                        </div>
                    </td>
        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                <div class="form-group">
                    Grand Total (Default Currency) {{\App\Helpers\Utility::defaultCurrency()}}
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->sum_total}}" readonly id="foreign_overall_sum_edit" name="grand_total" placeholder="Grand Total Defualt Currency">
                    </div>
                </div>
            </div>
            <div class="col-sm-4 ">
