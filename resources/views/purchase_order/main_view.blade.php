...
@section('content')
    ...
    <!-- EDIT MODAL FORM -->
    <div class="modal fade" id="editModalMini" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body" id="edit_content_mini" style="height:400px; overflow:scroll;">

                </div>
                <div class="modal-footer">
                    <button onclick="submitDefault('editModalMini','editMainFormMini','<?php echo url('edit_po_mini'); ?>','reload_data',
                            '<?php echo url('purchase_order'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-info waves-effect">
                        SAVE
                    </button>
                    <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                </div>
        ...
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="pull-right"><button type="button" onclick="warehousePost('kid_checkbox_po_edit','reload_data','<?php echo url('purchase_order'); ?>',
                                '<?php echo url('post_warehouse_receipt'); ?>','<?php echo csrf_token(); ?>','{{\App\Helpers\Utility::CREATE_RECEIPT}}','Create Warehouse Receipt');" class="btn btn-success waves-effect" ><i class="fa fa-plus"></i>Create Warehouse/Store Receipt</button></div>
