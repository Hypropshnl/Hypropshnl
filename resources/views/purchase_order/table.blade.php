<table class="table table-bordered table-hover table-striped " id="main_table">
    ...
    @foreach($mainData as $data)
        <tr>
            ...
            <td>
                <a style="cursor: pointer;" onclick="fetchHtml('{{$data->id}}','edit_content_mini','editModalMini','<?php echo url('edit_po_mini_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
            </td>
            <td>
