            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox_notes','reload_data_quick_notes','<?php echo url('quick_note'); ?>',
                ...
                <div class="body" id="reload_data_quick_notes">
                    <div class="row clearfix" id="notes_main_table">
                        <div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
                            <input type="checkbox" onclick="toggleme(this,'kid_checkbox_notes');" id="parent_check" name="check_all" class="" />
                            <b>Mark All</b>
                            ...
                            <div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
                                ...
                                @foreach($mainData as $data)
                                    <div class="panel panel-primary"><input value="{{$data->id}}" type="checkbox" id="quick_notes_{{$data->id}}" class="kid_checkbox_notes" />
