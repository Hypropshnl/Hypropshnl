<form name="" id="editMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <div class="body">
        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    Posting Date
                    <div class="form-line">
                        <input type="date" class="form-control " value="{{$edit->post_date}}" id="posting_date_edit" onkeyup="exchangeRate('vendorCust_edit','curr_rate_edit','posting_date','<?php echo url('exchange_rate'); ?>')" name="posting_date" placeholder="Posting Date">
                    </div>
                </div>
            </div>
        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                <div class="form-group">
                    Grand Total (Customer Currency Inc. Tax) {{\App\Helpers\Utility::defaultCurrency()}}
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->sum_total}}" readonly id="foreign_overall_sum_edit" name="grand_total" placeholder="Grand Total Customer Currency">
                    </div>
                </div>
            </div>
            <div class="col-sm-4 ">
