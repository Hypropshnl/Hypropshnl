...
@section('content')
    ...
    <table class="table-bordered table-hover table-striped">
        ...
        <tbody>
        <tr>
            <td>Customer: {{$po->vendorCon->name}}</td>
            <td>Customer Invoice No.:{{$po->vendor_invoice_no}}</td>
            <td>Billing Address: {{$po->vendorCon->address}}</td>
        </tr>
        <tr>
            @php $quoteNumber = (empty($po->quote_number) ? $po->id : $po->quote_number) @endphp
            <td>Quote Number: {{$quoteNumber}}</td>
