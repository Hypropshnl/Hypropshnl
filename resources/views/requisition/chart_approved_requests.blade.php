                    ...
                    <form name="import_excel" id="searchMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="body">
                            ...
                            <div class="row clear-fix">
                                ...
                                @elseif($detectHod == \App\Helpers\Utility::HOD_DETECTOR && !in_array(Auth::user()->role,\App\Helpers\Utility::ACCOUNT_HR_MANAGEMENT))
                            ...
                            <div class="row clear-fix">
                                ...
                                @elseif($detectHod == \App\Helpers\Utility::HOD_DETECTOR && !in_array(Auth::user()->role,\App\Helpers\Utility::ACCOUNT_MANAGEMENT))
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select  class="form-control show-tick" id="department" name="department[]" multiple data-selected-text-format="count">
