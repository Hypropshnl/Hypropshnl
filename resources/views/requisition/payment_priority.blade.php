            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li>
                            <button type="button" onclick="approveFinanceRequest('kid_checkbox','reload_data','<?php echo url('payment_priority'); ?>',
                                    '<?php echo url('approve_payment_priority'); ?>','<?php echo csrf_token(); ?>','0');" class="btn btn-success">
                                <i class="fa fa-check-square-o"></i>Process Request(s) for payment
                            </button>
                        </li>
