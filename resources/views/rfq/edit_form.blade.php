        ...
        <div class="row clear-fix">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    RFQ Status
                    <div class="form-line">
                        <select class="form-control" name="rfq_status" >
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    Due Date & Time
                    <div class="form-line">
                        <input type="datetime-local" class="form-control " value="{{$edit->due_date_time}}"  id="" name="due_date_time" placeholder="Due Date and Time">
                    </div>
                </div>
            </div>
        </div>
                ...
                <tr>
                    <td class="center-align" id="hide_button_acc_rfq_edit">
                        <div class="form-group center-align">
                            <div onclick="addMore('add_more_acc_rfq_edit','hide_button_acc_rfq_edit','100000','<?php echo URL::to('add_more'); ?>','acc_rfq_edit','hide_button_acc_rfq_edit');">
        ...
        <div class="row clearfix container">
            ...
            <div class="row clearfix">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" class="form-control" autocomplete="off" id="select_item_31" onkeyup="searchOptionListMultipleDetail('select_item_31','myUL_31','{{url('default_select')}}','search_multiple_vendor_detail','inv_31','vendor_desc_31','vendor_array_id_31','vendor_cust_mails');" name="select_vendor" placeholder="Select Vendor">

                            <input type="hidden" class="inv_class" value="" name="vendor_data" id="inv_31" />
                        </div>
                    </div>
                    <ul id="myUL_31" class="myUL"></ul>
                </div>
                <div class="col-sm-6">
                    <b>Vendor Emails</b>
                    <div class="form-group">
                        <div class="form-line">
                            <textarea class="form-control"  id="vendor_desc_31" name="emails" placeholder="Vendor Emails" required>{{$edit->mails}}</textarea>
                        </div>
                    </div>
                    <input type="hidden" id="vendor_array_id_31" name="vendor_array">
                </div>
            </div>
            <div class="row clearfix">
