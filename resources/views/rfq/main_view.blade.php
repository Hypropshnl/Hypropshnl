...
@section('content')
                        ...
                        <div class="body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" class="" autocomplete="off" id="select_inv" onkeyup="searchOptionListInvDetail('select_inv','myUL500','{{url('default_select')}}','search_inventory_detail','inv500','item_desc','unit_cost','unit_measure','qty','{{\App\Helpers\Utility::PURCHASE_DESC}}');" name="select_user" placeholder="Inventory Item">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" autocomplete="off" id="select_item30" onkeyup="searchOptionListMultipleDetail('select_item30','myUL30','{{url('default_select')}}','search_multiple_vendor_detail','inv30','vendor_desc','vendor_array_id','vendor_cust_mails');" name="select_vendor" placeholder="Select Vendor">

                                            <input type="hidden" class="inv_class" value="" name="vendor_data" id="inv30" />
                                        </div>
                                    </div>
                                    <ul id="myUL30" class="myUL"></ul>
                                </div>
                                <div class="col-sm-6">
                                    <b>Vendor Emails</b>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class="form-control"  id="vendor_desc" name="emails" placeholder="Vendor Emails" required></textarea>
                                        </div>
                                    </div>
                                    <input type="hidden" id="vendor_array_id" name="vendor_array">
                                </div>
                            </div>
                             <div class="row clearfix">
                                @include('includes.message_part_rfq')
    ...
    <div class="modal fade" id="editMiniModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="submitMediaFormClass('editMiniModal','editMiniForm','<?php echo url('edit_rfq_mini'); ?>','reload_data',
                            '<?php echo url('rfq'); ?>','<?php echo csrf_token(); ?>',['rfq_status_mini'
                            ],'mail_message_mini_edit')"
                            class="btn btn-info waves-effect">
                        SAVE CHANGES
                    </button>
                    <button type="button" class="btn btn-danger waves-effect" data-dismiss="modal">CLOSE</button>
    ...
    <div class="modal fade" id="convertModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Convert Content</h4>
                    <li class="dropdown pull-right">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            <i class="material-icons">more_vert Export</i>
                        </a>
                        @include('includes/print_pdf',[$exportId = 'convertMainForm', $exportDocId = 'convertMainForm'])
                    </li>

                </div>
                <div class="modal-body" id="convert_content" style="height:400px; overflow:scroll;">

                </div>
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormClass('convertModal','convertMainForm','<?php echo url('convert_mr'); ?>','reload_data',
                            '<?php echo url('rfq'); ?>','<?php echo csrf_token(); ?>',[
                                    'inv_class_edit','item_desc_edit','quantity_edit','unit_measure_edit',
                            'acc_class_edit','acc_desc_edit',
                            ],'mail_message_edit')"
            ...
            <div class="card">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control" autocomplete="off" id="select_mr" onkeyup="searchOptionList('select_mr','myUL10','{{url('default_select')}}','search_mr_select','convertMr');" name="select_mr" placeholder="Select Material Request">

                                <input type="hidden" class="user_class" name="convertMr" id="convertMr" />
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <button style="cursor: pointer;" class="btn btn-info" onclick="convertForm('convertMr','convert_content','<?php echo url('convert_mr_form') ?>','<?php echo csrf_token(); ?>','convertModal','')"><i class="fa fa-pencil-square-o "></i>Update/Convert Material Request to RFQ</button>
                        </div>
                    </div>
                </div>
