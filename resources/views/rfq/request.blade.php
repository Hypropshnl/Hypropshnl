            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        @if($appAccess === 1)
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_rfq_requests'); ?>',
                                    '<?php echo url('approve_rfq'); ?>','<?php echo csrf_token(); ?>','1');" class="btn btn-success">
                                <i class="fa fa-check-square-o"></i>Approve
                            </button>
                        </li>
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_rfq_requests'); ?>',
                                    '<?php echo url('approve_rfq'); ?>','<?php echo csrf_token(); ?>','0');" class="btn btn-danger">
                            ...
                            @if($data->approval_view == 1 && $data->deny_reason == '')
                                @if($data->next_user == Auth::user()->id)
                                    <tr>
                                        ...
                                        <td>
                                            <a style="cursor: pointer;" onclick="fetchHtml('{{$data->id}}','attach_content','attachModal','<?php echo url('edit_rfq_attachment_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                        </td>
                                        <td>
