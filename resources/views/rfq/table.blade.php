<table class="table table-bordered table-hover table-striped" id="main_table">
    ...
    @foreach($mainData as $data)
        <tr>
            ...
            <td>
                <a style="cursor: pointer;" onclick="fetchHtml2('{{$data->id}}','edit_mini_content','editMiniModal','<?php echo url('edit_rfq_mini_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
            </td>
            <td>
