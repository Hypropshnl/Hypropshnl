<form name="" id="convertQuoteForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <div class="body">
        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <div class="form-line">
                        ...
                        <input type="hidden" class="user_class_edit" value="" name="user" id="user_edit" />
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    Posting Date
                    <div class="form-line">
                        <input type="date" class="form-control " value="" id="posting_date_edit" onkeyup="exchangeRate('vendorCust_edit','curr_rate','posting_date_edit','<?php echo url('exchange_rate'); ?>')" name="posting_date" placeholder="Posting Date">
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    Due Date
                    <div class="form-line">
                        <input type="date" class="form-control " value="{{$edit->rfqDetail->due_date}}" id="due_date_edit" name="due_date" placeholder="Due Date">
                    </div>
                </div>
            </div>
            <input type="hidden" name="mr_id" value="{{$rfqMain->mr_id}}">
        </div>
        <hr/>
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    RFQ Number
                    <div class="form-line">
                        <input type="text" class="form-control" readonly name="rfq_no" value="{{$edit->rfqDetail->rfq_no}}" placeholder="RFQ Number">
                    </div>
                </div>
            </div>
            <div class="col-sm-4" >
                <div class="form-group">
                    ...
                    <div class="form-line">
                        <select  class="form-control"  id="" name="project" >
                            <option value="{{$rfqMain->project_id}}">{{$rfqMain->project->project_name}}</option>
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="{{$po->unit_cost_trans}}" class=" shared_sub_total_edit" readonly name="sub_total_acc{{$num1}}" id="sub_total_acc{{$num}}" placeholder="Sub Total" >
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="" value="{{$po->itemData->item_name}}" autocomplete="off" id="select_inv{{$num}}" onkeyup="searchOptionListInventory('select_inv{{$num}}','myUL500{{$num}}','{{url('default_select')}}','search_inventory_transact','inv500{{$num}}','item_desc{{$num}}','unit_cost{{$num}}','unit_measure{{$num}}','sub_total{{$num}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','qty{{$num}}','vendorCust_edit','posting_date_edit','total_tax_amount_edit','{{\App\Helpers\Utility::PURCHASE_DESC}}');" name="select_user" placeholder="Inventory Item">
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class=" " name="item_desc{{$num2}}" id="item_desc{{$num}}" placeholder="Description">{{$po->rfqDetail->rfq_desc}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class=" " name="store{{$num2}}" >
                                                <option value="">Select Receipt Store</option>
                                                @foreach(\App\Helpers\Utility::storeData() as $inv)
                                                    <option value="{{$inv->id}}">{{$inv->name}} ({{$inv->code}})</option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="{{$po->rate}}" class=" shared_rate_edit " name="unit_cost{{$num2}}" id="unit_cost{{$num}}" placeholder="Rate/Cost Amount"
                                                   onkeyup="itemSum('sub_total{{$num}}','unit_cost{{$num}}','inv500{{$num}}','qty{{$num}}','discount_amount{{$num}}','tax_amount{{$num}}','shared_sub_total_edit','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','{{url('get_rate')}}','shared_tax_amount_edit','shared_discount_amount_edit','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','tax_perct{{$num}}','discount_perct{{$num}}')">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class=" " value="" name="unit_measure{{$num2}}" id="unit_measure{{$num}}" placeholder="Unit Measure" >
                                        </div>
                                    </div>
                                </div>
                            </td> -->
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="  " value="" name="planned_date{{$num2}}" placeholder="Planned Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="  " value="" name="expected_date{{$num2}}" placeholder="Expected Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="  " value="" name="promised_date{{$num2}}" placeholder="Promised Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="{{$po->amount}}" class=" shared_sub_total_edit" readonly name="sub_total{{$num2}}" id="sub_total{{$num}}" placeholder="Sub Total" >
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="center-align" id="">
                                <div class="form-group">
                                    <div style="cursor: pointer;" id="" onclick="tempItemDeleteConvert('itemId{{$po->id}}','<?php echo url('delete_po_item_convert') ?>','','0.00','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','tax_amount{{$num}}','discount_amount{{$num}}','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','{{$po->po_id}}','<?php echo url('update_sum') ?>','reload_data','{{url('purchase_order')}}','po_extention')">
                                        <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                                    </div>
                                </div>
                            </td>
        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <select class="form-control" name="discount_type" >
                                <option value="{{\App\Helpers\Utility::LINE_ITEM_DISCOUNT}}">Line Item Discount</option>
                                <option selected value="{{\App\Helpers\Utility::ONE_TIME_DISCOUNT}}">One time discount excluding line item discount(s)</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-4 ">
                    ...
                    <div class="form-group ">
                        <div class="form-line">
                            <input type="number" value="{{$edit->discount}}" class="form-control" readonly name="one_time_discount_amount_edit" id="total_discount_amount_edit" placeholder="Discount Amount" >
                        </div>
                    </div>
                </div>
        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-4 ">
                    ...
                    <div class="form-group ">
                        <div class="form-line">
                            <input type="number" class="form-control" value="{{$edit->tax}}" readonly name="one_time_tax_amount_edit" id="total_tax_amount_edit" placeholder="Tax Amount" >
                        </div>
                    </div>
                </div>
        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                <div class="form-group">
                    <b>Grand Total  (Default Currency Incl. Tax) {{\App\Helpers\Utility::defaultCurrency()}}
                    <div class="form-line">
                        <input type="text" class="form-control"  readonly id="foreign_overall_sum_edit" name="grand_total" placeholder="Grand Total Default Currency">
                    </div>
                </div>
            </div>
            <div class="col-sm-4 ">
                <b>Grand Total(Incl. Tax) <span class="foreign_amount_edit"></span></b>
                <div class="form-group ">
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->total_amount}}" id="overall_sum_edit" readonly name="grand_total_vendor_curr" placeholder="Grand Total Vendor Currency">
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <b>Total(Excl. Tax) <span class="foreign_amount_edit"></span></b>
                <div class="form-group ">

                    <div class="form-line">
                        <input type="text" class="form-control" id="excl_overall_sum_edit" value="{{$edit->total_amount}}" readonly name="" placeholder="Grand Total(Excl. Tax) Vendor Currency">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row clearfix container">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="file" class="form-control" multiple="multiple" name="approval_files[]" >
                        </div>
                    </div>
                </div>
