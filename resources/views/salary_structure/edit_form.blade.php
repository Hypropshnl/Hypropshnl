    ...
    <div class="body">
        ...
        <div class="row clearfix">
            <div class="col-sm-6">
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->rate}}" name="rate" placeholder="Rate Per Day/Hour">
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" class="form-control" value="{{$edit->days_hours}}" name="days_hours" placeholder="Number of days/hours">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        ...
                        <select class="form-control" id="tax_id_edit" name="tax_system" >
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            <select class="form-control comp_type_edit" id="comp_edit{{$num}}" name="comp_type" >
