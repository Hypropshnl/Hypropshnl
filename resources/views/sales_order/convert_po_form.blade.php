<form name="" id="convertPoForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <div class="body">
        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    Posting Date
                    <div class="form-line">
                        <input type="date" class="form-control " value="{{$edit->post_date}}" id="posting_date_edit" onkeyup="exchangeRate('vendorCust_edit','curr_rate','posting_date_edit','<?php echo url('exchange_rate'); ?>')" name="posting_date" placeholder="Posting Date">
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                    ...
                    @if(!empty($po->item_id))
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td class="center-align" id="">
                                <div class="form-group">
                                    <div style="cursor: pointer;" id="" onclick="tempItemDeleteConvert('itemId{{$po->id}}','<?php echo url('delete_sales_item_convert') ?>','','0.00','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','tax_amount{{$num}}','discount_amount{{$num}}','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','{{$po->po_id}}','<?php echo url('update_sum') ?>','reload_data','{{url('sales_order')}}','sales_extention')">
                                        <i style="color:red;" class="fa fa-minus-circle fa-2x pull-right"></i>
                                    </div>
                                </div>
                            </td>
        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                <div class="form-group">
                    Grand Total (Default CurrencyIncl. Tax) {{\App\Helpers\Utility::defaultCurrency()}}
                    <div class="form-line">
