        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    Posting Date
                    <div class="form-line">
                        <input type="date" class="form-control " value="{{$edit->post_date}}" id="posting_date_edit" onkeyup="exchangeRate('vendorCust_edit','curr_rate_edit','posting_date_edit','<?php echo url('exchange_rate'); ?>')" name="posting_date" placeholder="Posting Date">
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    Due Date
                    <div class="form-line">
                        <input type="date" class="form-control " value="{{$edit->due_date}}" id="due_date_edit" name="due_date" placeholder="Due Date">
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <div class="form-line">
                        <select  class="form-control" name="department" >
                            <option value="{{$edit->dept_id}}" selected>{{$edit->deptDetail->dept_name}}</option>
                            @foreach($dept as $de)
                ...
                <tr>
                    <td class="center-align" id="hide_button_acc_edit">
                        <div class="form-group center-align">
                            <div onclick="addMore('add_more_acc_edit','hide_button_acc_edit','100000','<?php echo URL::to('add_more'); ?>','acc_edit','hide_button_acc_edit');">
            ...
            <table class="table table-bordered table-hover table-striped" id="po_main_table_edit">
                        ...
                        <tr id="itemId{{$po->id}}">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class=" " name="store{{$num2}}" >
                                                <option value="{{$po->store_id}}" selected>{{$po->storeDetail->name}} ({{$po->storeDetail->code}})</option>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="  " value="{{$po->planned_ship_date}}" name="planned_date{{$num2}}" placeholder="Planned Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="  " value="{{$po->expected_ship_date}}" name="expected_date{{$num2}}" placeholder="Expected Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="  " value="{{$po->promised_ship_date}}" name="promised_date{{$num2}}" placeholder="Promised Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                ...
                <tr>
                    <td class="col-sm-4" id="hide_button_po_edit">
                        <div class="form-group">
                            <div onclick="addMore('add_more_po_edit','hide_button_po_edit','100000','<?php echo URL::to('add_more'); ?>','sales_edit','hide_button_po_edit');">
                                <i style="color:green;" class="fa fa-plus-circle fa-2x pull-right"></i>
                            </div>
                        </div>
                    </td>
