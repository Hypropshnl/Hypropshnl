        ...
        <div class="modal-dialog modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="pull-right"><button type="button" onclick="warehousePost('kid_checkbox_po_edit','reload_data','<?php echo url('sales_order'); ?>',
                                '<?php echo url('post_warehouse_shipment'); ?>','<?php echo csrf_token(); ?>','{{\App\Helpers\Utility::CREATE_SHIPMENT}}','Create Warehouse Shipment');" class="btn btn-success waves-effect" ><i class="fa fa-plus"></i>Create Warehouse/Store Shipment</button></div>
