...
@section('content')
    ...
    <table class="table-bordered table-hover table-striped">
        ...
        <tbody>
        <tr>
            <td>Customer: {{$sales->vendorCon->name}}</td>
            <td>Customer Po No.:{{$sales->vendor_po_no}}</td>
    ...
    <table class="table-bordered table-hover table-striped pull-right">
        ...
        <tr>
            ...
            <td>{{Utility::numberFormat($sales->tax_trans)}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{Utility::numberFormat($sales->discount_trans)}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{Utility::numberFormat($sales->trans_total)}}</td>
        </tr>
        </tbody>
    </table><hr/>
