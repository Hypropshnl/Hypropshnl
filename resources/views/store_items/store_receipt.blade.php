...
@section('content')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaForm('editModal','editMainForm','<?php echo url('store_receipt_create'); ?>','reload_data',
                            '<?php echo url('store_receipt'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-info waves-effect">
                        SAVE
                    </button>
    ...
    <form name="receiptForm" id="receiptform"></form>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li>
                            <button type="button"  onclick="fetchHtmlWithItemsOpenModal('editModal','edit_content','<?php echo url('store_receipt_form'); ?>','kid_checkbox')" class="btn btn-success">
                                <i class="fa fa-check"></i>Receive Store Items
                            </button>
                        </li>
                        <li class="dropdown">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-3" id="" style="">
                                    <div class="form-group">
                                        <button class="btn btn-info col-sm-8" type="button" onclick="searchReport('searchMainForm','<?php echo url('store_receipt_search'); ?>','reload_data',
