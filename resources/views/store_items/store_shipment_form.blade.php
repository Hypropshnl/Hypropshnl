        ...
        @foreach($mainData as $edit)
            <div class="row clearfix">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <div class="form-line">
                            <input type="number" class="form-control" name="place_quantity[]" placeholder="Place Shipping Quantity">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <input type="hidden" name="shipment_qty[]" value="{{$edit->qty}}" >
            <hr>
        @endforeach
    </div>
</form>