    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog">
                    ...
                    <form name="createMainForm" id="createMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <b>Project (Not compulsory)</b>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="form-control" name="project"  required>
                                                <option value="">Select</option>
                                                @foreach($projects as $data)
                                                    <option value="{{$data->project_id}}">{{$data->project->project_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
     ...
     <div class="modal fade" id="importModal" tabindex="-1" role="dialog">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Import Users</h4>
                </div>
                <div class="modal-body" style="height:400px; overflow:scroll;">
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaForm('importModal','importMainForm','<?php echo url('import_temp_user'); ?>','reload_data',
                            '<?php echo url('temp_user'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
                    <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li>
                            <button class="btn btn-success" data-toggle="modal" data-target="#importModal"><i class="fa fa-plus"></i>Import</button>
                        </li>
                        <li>
                ...
                <div class="body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="btn-link"><a href="{{url('external/signup')}}" target="_blank">{{url('external/signup')}}</a></td>
                        </tr>
                        <tr>
                            <td>Job Candidates Signup Link</td>
                            <td class="btn-link"><a href="{{url('external/candidate')}}" target="_blank">{{url('external/candidate')}}</a></td>
                        </tr>
                        <tr>
                            <td>Clients (survey) Signup Link</td>
                            <td class="btn-link"><a href="{{url('client/survey/signup')}}" target="_blank">{{url('client/survey/signup')}}</a></td>
                        </tr>
                        <tr>
                            <td>All External Users Staff Signin Link</td>
                            <td class="btn-link"><a href="{{url('external')}}" target="_blank">{{url('external')}}</a></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
