                                        ...
                                        <div class="card">
                                            <div class="header">
                                                ...
                                                <ul class="header-dropdown m-r--5">
                                                    <li>
                                                        <button type="button" onclick="generalApproval('kid_checkbox','reload_data','<?php echo url('project/'.$item->id.'/timesheet_approval'.\App\Helpers\Utility::authLink('temp_user')); ?>',
