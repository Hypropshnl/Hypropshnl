                        ...
                        <div class="body">
                            ...
                            <div class="row clear-fix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea type="text"  class="form-control" name="location" placeholder="Location"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="body table-responsive tbl_scroll" id="reload_data">
                    <table class="table table-bordered table-hover table-striped" id="main_table">
                        ...
                        <tr>
                            ...
                            <td>                                
                                <a href="{{url('training_feedback_form/'.$data->id)}}" style="cursor: pointer;" ><i class="fa fa-pencil-square-o fa-2x"></i></a>                                
                            </td>
