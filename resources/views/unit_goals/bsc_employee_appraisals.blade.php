                            ...
                            <div class=" table-responsive" id="reload_data" >
                                ...
                                <table class="table table-bordered table-hover table-striped" id="main_table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a target="_blank" href="{{route('bsc_employee_appraisal_user_goal',
                                            ['userId' => $data->user_id,'deptId' => $data->userData->dept_id,
                                            'goalSetId' => $data->unit_goal_series_id,'type' => Utility::BSC_INDIVIDUAL])}}">Appraise Employee Goals
                                            </a>|
                                            <a target="_blank" href="{{route('bsc_employee_appraisal_user_goal',
                                            ['userId' => $data->user_id,'deptId' => $data->userData->dept_id,
                                            'goalSetId' => $data->unit_goal_series_id,'type' => Utility::BSC_UNIT])}}">Appraise Unit Goals
                                            </a>|
                                            <a target="_blank" href="{{route('bsc_employee_appraisal_user_goal',
                                            ['userId' => $data->user_id,'deptId' => $data->userData->dept_id,
                                            'goalSetId' => $data->unit_goal_series_id,'type' => Utility::BSC_COMPANY])}}">Appraise Company Goals
                                            </a>
                                        </td>
                                        <td>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="body row">
                            <form name="import_excel" id="searchMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <button class="btn btn-info" type="button" onclick="searchReport('searchMainForm','<?php echo url('search_assigned_bsc_employees'); ?>','reload_data_search',
