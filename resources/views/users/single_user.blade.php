                ...
                <div class="body ">
                    ...
                    <div class=" table-responsive" id="reload_data">
                        ...
                        <div class="image pull-right">
                            ...
                            <img src="{{ asset('images/'.$edit->photo) }}" class="" width="150" height="150"  alt="User" />
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control " value="{{$edit->dob}}" name="birthdate" placeholder="Date of Birth" >
