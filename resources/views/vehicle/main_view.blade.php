                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="vehicle_id" placeholder="Vehicle ID" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" name="engine_number" placeholder="Engine Number" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="ivhms_type" placeholder="IVHMS Type">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-line">
                                            <select  class="form-control" name="insurance_status" >
                                                <option value="{{Utility::STATUS_ACTIVE}}">Insurance Status</option>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea  class="form-control" name="current_condition" placeholder="Current Condition" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea  class="form-control " name="route" placeholder="Route" ></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea  class="form-control " name="servicing_parts" placeholder="Servicing Parts" ></textarea>
                                        </div>
                                    </div>
                                </div>
