...
<table class="table table-responsive">
    ...
    <tr>
        <td>File{{$num}}</td>
        <td><a target="_blank" href="<?php echo URL::to('download_vehicle_repair_attachment?file='); ?>{{$at}}">
        ...
        <td>
            ...
            <button type="button"  onclick="submitMediaForm('attachModal','removeAttachForm','<?php echo url('remove_vehicle_repair_attachment'); ?>','reload_data',
