        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Vehicle Repair</h4>
                </div>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class="form-control" name="fault_description" placeholder="Fault Description" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" class="form-control" id="" name="incident_date" placeholder="Incident Date" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaForm('createModal','createMainForm','<?php echo url('create_vehicle_repair'); ?>','reload_data',
                            '<?php echo url('vehicle_repair'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-info waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="attachModal" tabindex="-1" role="dialog">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaForm('attachModal','attachForm','<?php echo url('edit_vehicle_repair_attachment'); ?>','reload_data',
                            '<?php echo url('vehicle_repair'); ?>','<?php echo csrf_token(); ?>')"
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaForm('editModal','editMainForm','<?php echo url('edit_vehicle_repair'); ?>','reload_data',
                            '<?php echo url('vehicle_repair'); ?>','<?php echo csrf_token(); ?>')"
                            class="btn btn-link waves-effect">
                        SAVE CHANGES
                    </button>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('vehicle_repair'); ?>',
                                    '<?php echo url('delete_vehicle_repair'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                ...
                <table class="table table-bordered table-hover table-striped" id="main_table">
                    ...
                    @foreach($mainData as $data)
                        <tr>
                            ...
                            <td>
                                <a style="cursor: pointer;" onclick="editForm('{{$data->id}}','edit_content','<?php echo url('edit_vehicle_repair_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                            </td>
                            <td>
                                <a style="cursor: pointer;" onclick="fetchHtml('{{$data->id}}','attach_content','attachModal','<?php echo url('edit_vehicle_repair_attachment_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                            </td>
                            <!-- ENTER YOUR DYNAMIC COLUMNS HERE -->
                            <td>{{$data->vehicle_make}} {{$data->vehicle_model}} ({{$data->vehicleDetail->license_plate}})</td>
                            <td>{{$data->admin_verification}}</td>
                            <td>{{$data->incident_date}}</td>
                            <td>{{$data->fault_desc}}</td>
