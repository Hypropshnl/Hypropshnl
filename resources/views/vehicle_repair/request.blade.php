            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_vehicle_repair_requests'); ?>',
                                    '<?php echo url('approve_vehicle_repair'); ?>','<?php echo csrf_token(); ?>','1');" class="btn btn-success">
                                <i class="fa fa-check-square-o"></i>Approve
                            </button>
                        </li>
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_vehicle_repair_requests'); ?>',
                                    '<?php echo url('approve_vehicle_repair'); ?>','<?php echo csrf_token(); ?>','0');" class="btn btn-danger">
