    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Vehicle Work Order Approval
                    </h2>
                    <ul class="header-dropdown m-r--5">
                        @if($appAccess === 1 || $projectAppAccess === 1)
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_vehicle_service_log_requests'); ?>',
                                    '<?php echo url('approve_vehicle_service_log'); ?>','<?php echo csrf_token(); ?>','1');" class="btn btn-success">
                                <i class="fa fa-check-square-o"></i>Approve
                            </button>
                        </li>
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_vehicle_service_log_requests'); ?>',
                                    '<?php echo url('approve_vehicle_service_log'); ?>','<?php echo csrf_token(); ?>','0');" class="btn btn-danger">
