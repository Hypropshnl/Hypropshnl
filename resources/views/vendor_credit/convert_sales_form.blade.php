        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    Vendor Address
                    <div class="form-line">
                        <textarea class="form-control" readonly id="vendor_address_edit" name="vendor_address" placeholder="Vendor Address"></textarea>
                    </div>
                </div>
            </div>
                    ...
                    @if($po->account_id != '')
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td class="center-align" id="{{$po->unit_cost_trans}}">
                                <div class="form-group">
                                    <div style="cursor: pointer;" id="" onclick="tempItemDeleteConvert('itemId{{$po->id}}','<?php echo url('delete_vendor_credit_item_convert') ?>','{{$po->id}}','{{$po->extended_amount_trans}}','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','tax_amount_acc{{$num}}','discount_amount_acc{{$num}}','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','{{$po->po_id}}','<?php echo url('update_sum') ?>','reload_data','{{url('vendor_credit')}}','journal_extention')">
