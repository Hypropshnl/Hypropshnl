    ...
    <div class="body">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <div class="form-line">
                        ...
                        <input type="hidden" class="user_class" value="{{$edit->vendor_customer}}" name="pref_vendor" id="vendorCust_edit" />
                    </div>
                </div>
        ...
        <div class="row clearfix">
            ...
            <table class="table table-bordered table-hover table-striped" id="account_main_table_edit">
                ...
                @foreach($vendorCreditData as $po)
        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                <div class="form-group">
                    Grand Total (Vendor Currency Incl. Tax) {{$edit->currency->code}}
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->sum_total}}" readonly id="foreign_overall_sum_edit" name="grand_total" placeholder="Grand Total Vendor Currency">
                    </div>
                </div>
            </div>
            <div class="col-sm-4 ">
                Grand Total(Incl. Tax) {{\App\Helpers\Utility::defaultCurrency()}}
                <div class="form-group ">
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->trans_total}}" id="overall_sum_edit" readonly name="grand_total_vendor_curr" placeholder="Grand Total Default Currency">
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                Grand Total(Excl. Tax) {{\App\Helpers\Utility::defaultCurrency()}}
                <div class="form-group ">

                    <div class="form-line">
                        <input type="text" class="form-control" id="excl_overall_sum_edit" value="{{$exclTax}}" readonly name="" placeholder="Grand Total(Excl. Tax) Default Currency">
                    </div>
                </div>
            </div>
        </div>
        ...
        @foreach($attach as $at)
            ...
            <tr id="removeAttach{{$num}}">
                ...
                <td>
                    ...
                    <button type="button"  onclick="removeMediaForm('removeAttach{{$num}}','removeAttachForm','<?php echo url('vendor_credit_remove_attachment'); ?>','reload_data',
