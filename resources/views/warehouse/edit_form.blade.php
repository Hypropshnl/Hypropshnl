    ...
    <div class="body">
        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->whseManager->firstname}} {{$edit->whseManager->lastname}}" autocomplete="off" id="select_user1" onkeyup="searchOptionList('select_user1','myUL12','{{url('default_select')}}','default_search','user1');" name="select_user" placeholder="Select User">

                        <input type="hidden" class="user_class" name="warehouse_manager" id="user1" />
                    </div>
                </div>
